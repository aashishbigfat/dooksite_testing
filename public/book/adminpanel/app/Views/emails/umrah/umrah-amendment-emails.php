        ...
        <table style=" text-align: left; width:100%; padding: 10px; border-collapse: collapse;">
            <tr>
                <td style="width: 100%;">
                    ...
                    <p style="margin: 0; text-align: center; text-transform: uppercase; font-size: 18px;">Umrah Amendment Data</p>
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;"><?php echo $packagename; ?></td>
                        </tr>
                        <tr>
