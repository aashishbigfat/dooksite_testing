    ...
    <center style="padding:20px; width: 600px;margin:auto; border: 1px solid #C7C7C7; height: auto; position: absolute; top: 50%; left: 50%; background: #fff;  transform: translate(-50%, -50%);  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); font-family: 'Poppins', sans-serif;">
        <table style=" text-align: left; width:100%; padding: 10px; border-collapse: collapse;">
            <tr>
                <td style="width: 100%;">
                    ...
                    <p style="margin: 0; text-align: center; text-transform: uppercase; font-size: 18px;">Visa Amendment Data</p>
                </td>
            </tr>
        ...
        <table style=" text-align: left; width:100%; padding: 10px; border-collapse: collapse;">
            ...
            <tr>
                <td style="width: 100%; padding: 10px 6px;">
                    <h3 style="color: #333; margin: 0px 0;">
                        <strong><?php echo "Your amendment has been raised and same will be processed and updated." ?></strong>
                    </h3>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
                        <tr>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;">AMD Ref. No.</td>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;"><?php echo $AmendmentId; ?></td>
                        </tr>
                        <tr>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;">Booking Ref No.</td>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;"><?php echo $BookingRefNo; ?></td>
                        </tr>
                        <tr>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;">Visa Country</td>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;"><?php echo $visacountry; ?></td>
                        </tr>
                        <tr>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;">Visa Type</td>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;"><?php echo $visatype; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;">Amendment Type</td>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;"><?php echo $amendment_type; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;">Amendment Status</td>
                            <td style="font-size: 14px; padding: 5px 8px; border: 1px solid gray;"><?php echo ucfirst($Amendment_status); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
