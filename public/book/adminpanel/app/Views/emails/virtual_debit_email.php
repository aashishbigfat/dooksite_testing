         ...
         <tr>
            <td style="padding: 20px; color: #333333;">
               ...
               <div style="background-color: #f9f9f9; border: 1px solid #ddd; border-radius: 8px; padding: 15px; margin-bottom: 20px;">
                  ...
                  <p style="font-size: 16px; line-height: 1.5; margin-bottom: 5px;"><strong>Debit Amount:</strong> <?php echo htmlspecialchars($Currency); ?>  <?php echo htmlspecialchars($DebitedAmount); ?></p>
