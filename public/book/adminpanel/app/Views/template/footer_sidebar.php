...
if (!empty(session()->get("Message"))):
    ...
    <div class="message  <?= $message['Class'] ?>" onclick="this.classList.add('d-none');">
        <?php echo $message['Message']; ?>
    </div>
<?php endif ?>
<?php
if (!empty(session()->get("ExistingMessage"))):
    $message = session()->get("ExistingMessage"); ?>
    <div class="message  <?= $message['Class'] ?>" onclick="this.classList.add('d-none');">
        <?= $message['Message']; ?>
    </div>
<?php endif ?>
...
<input type="hidden" value="<?php echo admin_cookie_data()['admin_comapny_detail']['company_id']; ?>"
    id="web-partner-company-id">
...
<script type="text/javascript"
    src="<?php echo site_url('webroot'); ?>/js/jquery.multiselect.js<?php echo last_modifytime(FCPATH . 'webroot/js/jquery.multiselect.js'); ?>"></script>
