<div>
    <center
        style="padding:20px; width: 925px;margin:auto; border: 1px solid #C7C7C7; height: auto; position: absolute; top: 50%; left: 50%; background: #fff;  transform: translate(-50%, -50%);  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); font-family: 'Poppins', sans-serif;">
        <tr>
            <td style="width:100%;">
        ...
        <table style=" text-align: left; width:100%; padding: 10px; border-collapse: collapse;">
            ...
            <tr>
                <td style="padding: 10px;">
                    <table>
                        <tr>
                            <td style="padding: 10px; color: #555; line-height: 1.5;">
                                <?php echo $message; ?>
                            </td>
                        </tr>
                    </table>
                ...
                <td style="width: 100%; padding: 10px;">
                    <p style="text-align: left; margin: 0;  padding-bottom: 0px;">
                        <span> <span>Thanks &amp; Regards,</span> <br> <span>Team <span
                                    class="il"><?php echo super_admin_website_setting['company_name'] ?></span></span>
                        </span>
                    </p>
        ...
        <table style="width: 100%; background-color: #3e3e3e;">
            <tbody>
                <tr>
                    <td
                        style=" padding: 10px 10px 10px 10px; color: #ff1010;  font-weight: normal; text-align: center; ">
                        <h3 style="color: #fff; margin-top: 0px; text-align: center; margin-bottom: 0;">
                            <span> <span style="color: #fff; font-size: 12px; font-weight: 500;"> Need More help? We are
                                    Here, Ready to Talk. </span> </span>
                        </h3>
                            ...
                            <span style="font-size: 12px; color: #fff; margin-right: 30px;">
                                <a href="tel:<?php echo super_admin_website_setting['support_no'] ?>"
                                    ...
                                    <img src="<?php echo root_url . 'uploads/icons/' . 'call-icon.png' ?>"
                                        style="vertical-align: middle; margin-right: 5px; width: 15px;" alt="phone.png"
                                        class="CToWUd" data-bit="iit">
                                    <?php echo super_admin_website_setting['support_no'] ?>
                                </a>
                            </span>
                            <span>
                                <a href="mailto:<?php echo super_admin_website_setting['support_email'] ?>"
                                    style="color: #fff; font-size: 12px;" target="_blank"> <img
                                        ...
                                        style="vertical-align: middle; margin-right: 5px; width: 15px;" alt="mail.png"
