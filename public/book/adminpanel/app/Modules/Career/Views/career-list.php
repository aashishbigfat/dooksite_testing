    ...
    <div class="page-content">
            ...
            <div class="sale_bar">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8 text-end">
                        <?php if (permission_access("Career", "career_applications")) { ?>
                        <a href="<?php echo site_url('/career/job-applications-list/'); ?>" class="badge badge-wt" ><i class="fa-solid fa-list"></i> Job Applications List</a>
                        <?php }?>
                        <?php if (permission_access("Career", "add_career")) { ?>
                        <button class="badge badge-wt" view-data-modal="true" data-controller='career'  data-href="<?php echo site_url('career/add-career-template')?>"> <i class="fa-solid fa-add "></i> Add Career </button>
                        <?php }?>
                        <?php if (permission_access("Career", "career_status")) { ?>
                        ...
                        <?php }?>
                        <?php if (permission_access("Career", "delete_career")) { ?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row ">
                <!----------Start Search Bar ----------------->
                <form action="<?php echo site_url('career'); ?>" method="GET" class="row" name="career-search" onsubmit="return searchvalidateForm()">
                    <div class="col-md-3">
                        <div class="form-group form-mb-20">
                            ...
                            <select name="key" class="form-select" onchange="tts_searchkey(this,'career-search')" tts-validatation="Required" tts-error-msg="Please select search key">
                                ...
                                <option value="offer_salary" <?php if(isset($search_bar_data['key']) && $search_bar_data['key']=='offer_salary'){ echo "selected";} ?>  >Salary Offer</option>
                                <option value="experience" <?php if(isset($search_bar_data['key']) && $search_bar_data['key']=='experience'){ echo "selected";} ?>  >Experience</option>
                    ...
                    <? if(isset($search_bar_data['key'])): ?>
                        <div class="col-md-3 mb-3">
                            <div class="search-reset-btn">
                                <a href="<?php echo site_url('career');?>">Reset Search</a>
                            </div>
                        </div>
                    <? endif ?>
                </form>
            ...
            <!----------End Search Bar ----------------->
                <div class="table-responsive">
                    <?php
                    $trash_uri = "career/remove-career";
                    ?>
                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true" id="formbloglist">
                        <table class="table table-bordered table-hover">
                            <thead class="table-active">
                            <tr>
                                <?php if (permission_access("Career", "career_status") || permission_access("Career", "delete_career")) { ?>
                                ...
                                <th>Created Date</th>
                                <th>Modified Date</th>
                                <?php if (permission_access("Career", "edit_career")) { ?>
                                <th>Action</th>
                                <?php }?>
                            ...
                            if (!empty($list) && is_array($list)) {
                                foreach ($list as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="txt_led_clr" view-data-modal="true" data-controller='career' data-id="<?php echo dev_encode($data['id']); ?>" data-href="<?php echo site_url('career/career-details/') . dev_encode($data['id']); ?>"><?php echo ucfirst($data['job_title']); ?></a>
                                        </td>
                                        <td><?php echo ($data['job_category']); ?></td>
                                       
                                        <td><?php echo ($data['offer_salary']); ?></td>
                                        ...
                                        <?php if (permission_access("Career", "edit_career")) { ?>
                                        <td>
                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='career' data-id="<?php echo dev_encode($data['id']); ?>" data-href="<?php echo site_url('/career/edit-career-template/') . dev_encode($data['id']); ?>"><i class="fa-solid fa-edit "></i></a>
                                        </td>
                                        <?php }?>
                                    </tr>
                                <?php }
                            } else {
                                echo "<tr> <td  class='text-center' colspan='8'><b>No Career Found</b></td></tr>";
                            } ?>
                            </tbody>
                        </table>
                ...
                <div class="row pagiantion_row align-items-center">
                            <div class="col-md-6 mb-3 mb-lg-0">
                                <p class="pagiantion_text">Page  records found </p>
                            </div>
...
<div id="status_change" class="modal fade">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <form action="<?php echo site_url('career/career-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
