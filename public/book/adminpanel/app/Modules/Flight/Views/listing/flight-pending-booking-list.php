      ...
      <div class="sale_bar">
         <div class="row">
            <div class="col-md-4 mb-3 mb-lg-0">
               <h5 class="m0"> Flight Pending Booking List</h5>
            </div>
      ...
      <div class="page-content-area">
         <div class="card-body">
            <div class="row align-items-center">
               <!----------Start Search Bar ----------------->
               <form action="<?php echo site_url('flight/pending-bookings'); ?>" method="GET"
                  ...
                  <div class="col-md-2 mb-3">
                     <div class="search-reset-btn">
                        <a href="<?php echo site_url('flight/pending-bookings'); ?>">Reset Search</a>
                     </div>
                  </div>
                  <? endif ?>
               </form>
