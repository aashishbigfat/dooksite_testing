        ...
        <div class="table_title">
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h5 class="m-0"> Bus Booking List</h5>
                    </div>
            ...
            <div class="page-content-area p-0">
                ...
                <form action="<?php echo site_url('sale-result'); ?>" method="GET" class=" mb-3 tts-dis-content" id="sales-export" name="markup-search" onsubmit="return searchvalidateForm()">
                    <input type="hidden" name="q" value="Bus">
                    <div class="row align-items-center mt-3">
                        ...
                        <div class="col-md-1">
                            <? if (isset($search_bar_data['key'])) : ?>
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('sale-result?q=Bus'); ?>">Reset Search</a>
                                </div>
                            <? endif ?>
                        </div>
                        ...
                        <input type="hidden" name="service" value="Bus">
                    </div>
                </form>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            if (!empty($list) && is_array($list)) {
                                ...
                                foreach ($list as $data) {
                                    ...
                                    foreach ($fareBreakupArray as $key => $HotelRooms) {
                                        ...
                                        if(isset($web_partner_fare_break_up[$key])){
                            ...
                            ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo site_url('/bus/details/') . $data['booking_ref_number']; ?>" target="<?php echo target ?>"><?php echo $data['booking_ref_number']; ?></a>
                                        </td>
                                        ...
                                        <td><?php echo $data['travel_operator_pnr']; ?></td>

                                        <td>
                                            <?php foreach ($FareBreakUp['FareBreakup'] as $fare) {
                                                if ($fare['LabelText'] != 'CommEarned' && $fare['LabelText'] != 'Discount (-)' && $fare['LabelText'] != 'TDS (+)') { ?>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('/bus/confirmation/') . $ticketData = $data['booking_ref_number']; ?>" target="<?php echo target ?>"><i class="tts-icon eye"> View</i></a>
                                        </td>
                                    </tr>
                            <?php }
                            } else {
