        ...
        <div class="table_title">
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h5 class="m-0"> Car Sales Report</h5>
                    </div>
            ...
            <form action="<?php echo site_url('sale-result'); ?>" method="GET" class="row g-3 mb-3 tts-dis-content" id="sales-export" name="markup-search" onsubmit="return searchvalidateForm()">
                            <input type="hidden" name="q" value="Car">
                            ...
                            <div class="col-md-1">
                                <? if (isset($search_bar_data['key'])) : ?>
                                    <div class="search-reset-btn">
                                        <a href="<?php echo site_url('sale-result?q=Car'); ?>">Reset Search</a>
                                    </div>
                                <? endif ?>
                            </div>
                            ...
                            if (!empty($list) && is_array($list)) {
                                ...
                                foreach ($list as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('/car-extranet/details/') . $data['booking_ref_number']; ?>"
                                               target="<?php echo target;?>"><?php echo $data['booking_ref_number']; ?></a></td>
                                        ...
                                        <td>
                                            <?php foreach ($FareBreakUp['FareBreakup'] as $fare) {
                                                if ($fare['LabelText'] != 'Comm Earned (-)' && $fare['LabelText'] != 'Discount (-)' && $fare['LabelText'] != 'TDS (+)') { ?>
                                                    ...
                                                    <i class="fa fa-inr"
                                                       aria-hidden="true"></i> <?php echo custom_money_format($fare['Value']); ?>
                                                    <br/>
                                                <?php }
                                                ?>
                                            <?php } ?>
                                            ...
                                            <i class="fa fa-inr"
                                               aria-hidden="true"></i> <?php echo custom_money_format($FareBreakUp['TotalAmount']['Value']); ?>
                                        </td>
                                        <td>
                                            <?php foreach ($FareBreakUp['FareBreakup'] as $fare) {
                                                if ($fare['LabelText'] == 'Comm Earned (-)' || $fare['LabelText'] == 'Discount (-)' || $fare['LabelText'] == 'TDS (+)') { ?>
                                        ...
                                        <td>
                                            <b>Taxable
                                                Value:<i class="fa fa-inr"
                                                         aria-hidden="true"></i> <?php echo custom_money_format($FareBreakUp['GSTDetails']['TaxableAmount']); ?>
                                            </b> </br>
                                            <b>CGST @ <?php echo $FareBreakUp['GSTDetails']['CGSTRate']; ?>
                                                %:</b><i class="fa fa-inr"
                                                         aria-hidden="true"></i> <?php echo custom_money_format($FareBreakUp['GSTDetails']['CGSTAmount']); ?>
                                            <br/>
                                            <b>SGST @ <?php echo $FareBreakUp['GSTDetails']['SGSTRate']; ?>
                                                %:</b><i class="fa fa-inr"
                                                         aria-hidden="true"></i> <?php echo custom_money_format($FareBreakUp['GSTDetails']['SGSTAmount']); ?>
                                            <br/>
                                            <b>IGST @<?php echo $FareBreakUp['GSTDetails']['IGSTRate']; ?>
                                                %:</b><i class="fa fa-inr"
                                                         aria-hidden="true"></i> <?php echo custom_money_format($FareBreakUp['GSTDetails']['IGSTAmount']); ?>
                                            <br/>
                                            <b>Total:</b><i class="fa fa-inr"
                                                            aria-hidden="true"></i> <?php echo custom_money_format($FareBreakUp['GSTDetails']['CGSTAmount'] + $FareBreakUp['GSTDetails']['SGSTAmount'] + $FareBreakUp['GSTDetails']['IGSTAmount']); ?>
                                            <br/>
                                        </td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('/car-extranet/confirmation/') .  $ticketData = dev_encode(json_encode(array("booking_ref_number" => $data['booking_ref_number'], "BookingToken" => $data['tts_search_token']))) ?>" target  =  "<?php echo target;?>"><i class="tts-icon eye"> View </i></a>&emsp13;
                                ...
                                echo "<tr> <td colspan='18' class='text-center'><b>No Booking Found</b></td></tr>";
                            } ?>
                            </tbody>
                        </table>
