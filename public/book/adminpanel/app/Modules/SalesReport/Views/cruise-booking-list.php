        ...
        <div class="table_title">
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h5 class="m-0"> Cruise Sales Report</h5>
                    </div>
            ...
            <form action="<?php echo site_url('sale-result'); ?>" method="GET" class="mb-3 tts-dis-content" id="sales-export" name="markup-search" onsubmit="return searchvalidateForm()">
                    <input type="hidden" name="q" value="Cruise">
                       <div class="row mt-3">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-1">
                                <? if (isset($search_bar_data['key'])) : ?>
                                    <div class="search-reset-btn">
                                        <a href="<?php echo site_url('sale-result?q=Cruise'); ?>">Reset Search</a>
                                    </div>
                                <? endif ?>
                            </div>
                            ...
                            <input type="hidden" name="service" value="Cruise">
                        </form>
                    </div>
                    <!----------End Search Bar ----------------->
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            if (!empty($list) && is_array($list)) {
                                ...
                                foreach ($list as $data) {
                                    ...
                                    $ticketData = dev_encode(json_encode(array("BookingRefNo" => $data['booking_ref_number'], "BookingToken" => $data['tts_search_token'])));
