...
<form  action="<?php echo site_url('private-fare/add-seat-allocation/') .dev_encode($private_fare_id); ?>" method="post" tts-form="true" name="add_blogs">      
   ...
   <div class="row">   
      ...
      <div class="col-md-3">
         <div class="form-group form-mb-20">
            ...
            <input type="text" class="form-control" value="<?php echo date('d-M-y')?>"  praveen-from-date="true" name="start_date"  placeholder="Start (Date)">
         </div>
      </div>
      <div class="col-md-3">
         <div class="form-group form-mb-20">
            <label for="">End (Date)</label>
            <input type="text" class="form-control" value="<?php echo date('d-M-y')?>"  praveen-to-date="true" name="end_date" placeholder="End (Date)">
         </div>
      </div>
      <div class="col-md-3">
         <div class="form-group form-mb-20">
