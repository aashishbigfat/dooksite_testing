...
<form  action="<?php echo site_url('private-fare/edit-return-international-seat-allocation/') . dev_encode($details['id']); ?>" method="post" tts-form="true" name="add_blogs">
   <div class="modal-body">
      <div class="row">
         ...
         <div class="form-group form-mb-20">
            ...
            <input type="text" class="form-control" value="<?php echo $details['date']; ?>"  praveen-from-date="true" name="date"  placeholder="Onward (Date)">
         </div>
      </div>
      <div class="col-md-3">
         <div class="form-group form-mb-20">
            <label for="">Reurn Date</label>
            <input type="text" class="form-control" praveen-to-date="true" name="date_return" placeholder="Reurn (Date)" value="<?php echo $details['date_return']; ?>">
         </div>
      </div>
         <div class="col-md-3">
            <div class="form-group form-mb-20">
               ...
               <input type="text" class="form-control" name="available_seats"
                  value="<?php echo $details['available_seats']; ?>" id="seats-available"
            ...
            <div class="row mt-4">
               <div class="col-md-6">
                  <div class="form-check">
                     <input class="form-check-input" type="checkbox" value="1" name="rate_plan_check" id="rate-plan-check" checked>
               ...
               <div class="col-md-6">
                  <div class="form-check">
                     <input class="form-check-input" type="checkbox" value="1" name="seat_check" id="seat-check" checked>
               ...
               <div class="col-md-6">
                  <div class="form-check">
                     <input class="form-check-input" type="checkbox" value="1" name="segment_check" id="segment-check" checked>
