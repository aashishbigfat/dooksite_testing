        ...
        <div class="page-content-area">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb_10">
                        <!----------Start Search Bar ----------------->
                        <form action="<?php echo site_url('logs/coupon-log'); ?>" method="GET" class="row" name="discount-search" onsubmit="return searchvalidateForm()">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <? if (isset($search_bar_data['key'])) : ?>
                                    ...
                                    <div class="search-reset-btn">
                                        <a href="<?php echo site_url('logs/coupon-log'); ?>">Reset Search</a>
                                    </div>
