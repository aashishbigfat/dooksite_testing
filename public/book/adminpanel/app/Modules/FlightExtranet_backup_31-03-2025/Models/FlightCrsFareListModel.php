...
class FlightCrsFareListModel extends Model
{
    ...
    public function flight_crs_list($web_partner_id)
    {
        return $this->select('flight_crs_fare_list.id, flight_crs_fare_list.web_partner_id, flight_crs_fare_list.inventory_name, flight_crs_fare_list.origin, flight_crs_fare_list.destination, flight_crs_fare_list.trip_type, flight_crs_fare_list.journey_type, flight_crs_fare_list.onward_segment_detail, flight_crs_fare_list.status')
            ->join("suppliers", "suppliers.id = flight_crs_fare_list.supplier_id", 'left')
            ->where(['flight_crs_fare_list.web_partner_id' => $web_partner_id])
            ->orderBy('flight_crs_fare_list.id', 'DESC')
    ...
    public function getRowData($tableName, $whereCondition)
    {
        $builder = $this->db->table($tableName)->select("flight_crs_fare_list.id, flight_crs_fare_list.web_partner_id, flight_crs_fare_list.inventory_name, flight_crs_fare_list.origin, flight_crs_fare_list.destination, flight_crs_fare_list.trip_type, flight_crs_fare_list.journey_type, flight_crs_fare_list.onward_segment_detail, flight_crs_fare_list.status");
        if ($whereCondition) {
