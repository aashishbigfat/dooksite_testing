...
<form action="<?= site_url('private-fare/edit-seat-allocation/') . dev_encode($details['id']); ?>" method="post"
      ...
      <div class="row">
         ...
         <div class="col-md-3" id="start_date">
            <div class="form-group form-mb-20">
               ...
               <input type="text" class="form-control" value="<?= $details['date']; ?>" name="start_date"
         ...
         <div class="col-md-3" id="end_date">
            <div class="form-group form-mb-20">
               ...
               <input type="text" class="form-control" value="<?= $details['date']; ?>" name="end_date"
