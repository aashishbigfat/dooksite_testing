...
<form action="<?= site_url('private-fare/add-return-international-seat-allocation/') . dev_encode($private_fare_id); ?>"
      ...
      <div class="row">
         ...
         <div class="col-md-3">
            <div class="form-group form-mb-20">
               ...
               <input type="text" class="form-control" value="<?= date('d-M-y') ?>" praveen-from-date="true" name="date"
         ...
         <div class="col-md-3">
            <div class="form-group form-mb-20">
               ...
               <input type="text" class="form-control" value="<?= date('d-M-y') ?>" praveen-to-date="true"
                  name="date_return" placeholder="Reurn (Date)">
            </div>
         </div>
         <div class="col-md-3">
            <div class="form-group form-mb-20">
