                     ...
                     <div class="col-md-3">
                        <div class="form-group form-mb-20">
                           ...
                           <select name="key" class="form-select " onchange="tts_searchkey(this,'web-partner-search')" tts-validatation="Required" tts-error-msg="Please select search key">
                              ...
                              <option value="inventory_name" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'inventory_name') {
                                                                  echo "selected";
                                                               } ?>>Inventory Name </option>
                              <option value="company_id" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'company_id') {
                                                            echo "selected";
                                                         } ?>>Supplier Id </option>
