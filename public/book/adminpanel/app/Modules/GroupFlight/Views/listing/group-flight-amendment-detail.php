         ...
         <div class="sale_bar">
            <div class="row align-items-center">
               ...
               <div class="col-md-8 text-md-end">
                  <a class="badge badge-wt" href="<?php echo site_url('/groupflight/confirmation/') . $ticketData = dev_encode(json_encode(array($bookingDetail['flightbookingid']))); ?>" target  =  "_blank">Booking Summary</a>
               </div>
            </div>
         </div>
         <div class="row">
