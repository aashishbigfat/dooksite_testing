   ...
   <div class="page-content">
      <div class="table_title">
         <div class="sale_bar">
            <div class="row">
               <div class="col-md-4">
                  <h5 class="m-0">Group Flight Booking List</h5>
               </div>
         ...
         <div class="page-content-area">
            <div class="card-body">
               ...
               <!----------Start Search Bar ----------------->
               <form class="" action="<?php echo site_url('groupflight/bookings-search'); ?>" method="GET" class="tts-dis-content" name="markup-search" onsubmit="return searchvalidateForm()">
                     ...
                     <? if (isset($search_bar_data['key'])) : ?>
                        <div class="col-md-2">
                           <div class="search-reset-btn">
                              <a href="<?php echo site_url('groupflight/bookings'); ?>">Reset Search</a>
                           </div>
                        </div>
                     <? endif ?>
                  </div>
                  ...
                  <table class="table table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        ?>
                              <tr>
                                 <td>
                                    <a href="<?php echo site_url('/groupflight/details/') . $data['booking_ref_number']; ?>" target="<?php echo target ?>"><?php echo $data['booking_ref_number']; ?></a>
                                 </td>
                                    ...
                                    <?php if ($edit_status['permission']): ?>
                                       ...
                                       <?php } else if ($data['webpartner_assign_user'] != NULL && $data['webpartner_assign_user'] != '' && $data['webpartner_assign_user'] != admin_cookie_data()['admin_user_details']['id']) { ?>
                                          ...
                                          <?php if ($data['booking_status'] == "Failed" || $data['booking_status'] == "Processing" || $data['booking_status'] == "Hold") { ?>
                                             <a class="lead_assignbtn re_aassign" href="<?php echo site_url('/groupflight/assign-update-flight-ticket/') . $ticketData = dev_encode($data['booking_ref_number']); ?>"> ReAssign</a>
                                          <?php } ?>
                                          <?php } else {
                                          if ($data['booking_status'] == "Failed" || $data['booking_status'] == "Processing" || $data['booking_status'] == "Hold") { ?>
                                             <a class="lead_assignbtn aassign flightdisablelinks" href="<?php echo site_url('/groupflight/assign-update-flight-ticket/') . $ticketData = dev_encode($data['booking_ref_number']); ?>" id='countdown<?php echo $count; ?>'> Assign</a>
                                 ...
                                 <td>
                                    <a href="<?php echo site_url('/groupflight/confirmation/') . $ticketData = dev_encode(json_encode(array($data['id']))); ?>" target="<?php echo target ?>"><i class="tts-icon eye"> View</i></a>
                                    <br />
                                    <?php if (($data['webpartner_assign_user'] != NULL && $data['webpartner_assign_user'] != '' && $data['webpartner_assign_user'] == admin_cookie_data()['admin_user_details']['id'] && $data['webpartner_assign_user'] == admin_cookie_data()['admin_user_details']['id']) || admin_cookie_data()['admin_user_details']['primary_user'] == 1) { ?>
                                       <a href="<?php echo site_url('/groupflight/get-update-flight-ticket-info/') . $ticketData = $data['booking_ref_number']; ?>" target="<?php echo target ?>"><i class="tts-icon eye"> Edit <br /></i></a>
                                    <?php } ?>
                                 </td>
                              </tr>
                        <?php }
