         ...
         <div class="container-fluid p-0">
            <div class="sale_bar">
               <div class="row align-items-center">
                  <div class="col-md-4">
                     <h5 class="m-0">Group Flight Booking Details (<?php echo $bookingDetail['booking_ref_number']; ?>)</h5>
                  </div>
                  <div class="col-md-8 text-md-end">
                     ...
                     <?php }  ?>
                     <a class="badge badge-wt" href="<?php echo site_url('/groupflight/confirmation/') . $ticketData = dev_encode(json_encode(array($bookingDetail['id']))); ?>">
                     ...
                     ?>
                        <?php if (($bookingDetail['webpartner_assign_user'] != NULL && $bookingDetail['webpartner_assign_user'] != '' && $bookingDetail['webpartner_assign_user'] == admin_cookie_data()['admin_user_details']['id'] && $bookingDetail['webpartner_assign_user'] == admin_cookie_data()['admin_user_details']['id']) || admin_cookie_data()['admin_user_details']['primary_user'] == 1) { ?>
                           <a href="<?php echo site_url('/groupflight/get-update-flight-ticket-info/') . $ticketData = $bookingDetail['booking_ref_number']; ?>" target="<?php echo target ?>" class="badge badge-wt"><i class="fa-solid fa-edit"></i> Edit
                              Booking</a>
                        <?php } ?>
                     <?php } ?>
                  </div>
