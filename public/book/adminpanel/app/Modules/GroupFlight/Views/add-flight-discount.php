...
<div class="vewmodelhed">
   <form action="<?php echo site_url('flight/add-discount'); ?>" method="post" tts-form="true"
         ...
         <div class="col-md-4">
            ...
            <div class="col-md-4">
               <div class="form-group form-mb-20">
                  ...
                  <input class="form-control" type="text" tts-get-airline-multiple="true"  name="airline_code"
