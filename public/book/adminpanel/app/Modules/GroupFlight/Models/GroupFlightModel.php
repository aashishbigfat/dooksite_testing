...
class GroupFlightModel extends Model
{
    ...
    function getBookingConfirmationData($bookingid,$web_partner_id)
    {
        ...
        $query = $builder->get()->getRowArray();
        if($query){
        $paymentgatewayDetailbuilder = $this->db->table('group_flight_booking_list');
        ...
        ->join("super_admin_payment_transaction","super_admin_payment_transaction.booking_ref_no=group_flight_booking_list.id");
        $paymentgatewayDetailbuilder->where(['group_flight_booking_list.id' => $bookingid, 'group_flight_booking_list.web_partner_id' => $web_partner_id,"super_admin_payment_transaction.service"=>"flight"]);
    ...
    function getBookingWithBookingRefNumberWithVariableFieldNameData($bookingRefNumber,$web_partner_id,$fieldName)
    {
        ...
        $builder = $this->db->table("group_flight_booking_list");
        $builder->select($fieldName);
        $builder->where(['group_flight_booking_list.booking_ref_number' => $bookingRefNumber, 'group_flight_booking_list.web_partner_id' => $web_partner_id]);
        $query = $builder->get()->getRowArray();
        return $query;
    }
