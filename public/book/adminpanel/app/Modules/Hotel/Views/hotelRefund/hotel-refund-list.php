    ...
    <div class="page-content">
        <div class="table_title">
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-3 mb-lg-0">
                        <h5 class="m0"> Hotel Refund List</h5>
                    </div>
            ...
            <div class="page-content-area">
                <div class="card-body">
                    <form action="<?php echo site_url('hotel/hotel-refunds'); ?>" method="GET" class="tts-dis-content" name="flight-refunds-search" onsubmit="return searchvalidateForm()">
                        <div class="row align-items-center">
                            <!----------Start Search Bar ----------------->
                            ...
                            <div class="col-md-2 align-self-end">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="badge badge-md badge-primary badge_search" onclick="noExportExcel()"> Search <i class="fa-solid fa-search"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <? if (isset($search_bar_data['key'])) : ?>
                                    <div class="search-reset-btn">
                                        <a href="<?php echo site_url('hotel/hotel-refunds'); ?>">Reset Search</a>
                                    </div>
                                <? endif ?>
                            </div>
                                ...
                                if (!empty($list) && is_array($list)) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('/hotel/amendments-details/') . $ticketData = dev_encode($data['id']); ?>" target="<?php echo target ?>"><i class="fa fa-eye"> </i> <?php echo ucfirst($data['id']); ?></a>
                                            </td>

                                            <td><?php echo ucfirst($data['amendment_type']); ?></td>
                                            <td> <?php echo defaultCurrency; ?> <?php echo $data['refund_amount']; ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <?php echo 'Hotel: ' . ucfirst($data['hotel_name']) ?> <br />

                                                <?php echo 'City: ' . ucfirst($data['city'] . " ( " . $data['country_code'] . ")") ?>
                                            </td>
                                            ...
                                            <td>
                                                <?php echo !empty($data['account_remark']) ? ucfirst($data['account_remark']) : ''; ?>
                                            </td>
    ...
    <div id="flight_refund_close" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo site_url('hotel/hotel-refund-close'); ?>" method="post" tts-form="true" name="hotel_refund_close">
