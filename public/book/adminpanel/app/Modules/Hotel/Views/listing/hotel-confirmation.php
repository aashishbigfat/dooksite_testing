        ...
        <?php if ($hotelInfo) {
                    ...
                    <div class="row">
                        <div class="travelimp__thanku--bookingSuccess d-flex align-items-center">
                            ...
                            <div class="travelimp__thanku--statuscontent">
                                Booking<span class="<?php echo $hotelInfo['booking_status'] == "Confirmed" ? "tts-text-success" : "tts-text-danger" ?> travelimp__thanku--statussize"><?php echo $hotelInfo['booking_status'];  ?></span>
                                <p class="travelimp__thanku--bookingIdShow"><b>Booking Ref Number : </b><a href="<?php echo site_url('/hotel/details/') . $hotelInfo['booking_ref_number']; ?>" target="_blank" class="travelimp__thanku--redirectid"><?php echo $hotelInfo['booking_ref_number']; ?></a></p>
                                <?php if ($hotelInfo['confirmation_no']) { ?>
                                    <p class="travelimp__thanku--bookingIdShow"><b> Hotel Confirmation No : </b><a href="" class="travelimp__thanku--redirectid"><?php echo $hotelInfo['confirmation_no']; ?></a></p>
                                <?php } ?>
                                <?php if ($hotelInfo['last_cancellation_date']) { ?>
                                    <p class="travelimp__thanku--bookingIdShow">
                                        Last Cancellation Date: <?php echo display_custom_date_format($hotelInfo['last_cancellation_date'], true); ?></p>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
            ...
            <section class="flight-confirmation" ng-app="HotelDetailApp" ng-controller="hotelDetailCtrl">
                <div class="container-fluid p-0">
                            ...
                            <div class="travelimp__thanku--leftside">
                                <div class="travelimp__thanku--panelHeadwrap">
                                    <div class="travelimp__thanku--flightFlex">
                                        <div class="travelimp__thanku--flightFlex">
                                            <div class="travelimp__thanku--panelHeading travelimp__thanku--panelHeading-positionHandle"><?php echo $hotelInfo['hotel_name']; ?> <span class="travelimp__thanku--arrowIcon"> <?php for ($star = 1; $star <= $hotelInfo['star_rating']; $star++) { ?>
                                                        <i class="fa fa-star"></i>
                                                    <?php } ?></span> <span class="travelimp__thanku--tripdate travelimp__thanku--tripdate-positionHandle"> <?php echo date('d,M, Y D', strtotime($hotelInfo['check_in_date'])) ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <ul class="travelimp__segmentwrap--stoparrowul travelimp__segmentwrap">
                                                        <li class="travelimp__segmentwrap--stoparrowlist"><?php echo $night = $hotelInfo['no_of_nights']; ?> Nights </li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-5">
                                                    <ul class="travelimp__segmentwrap--airportul travelimp__segmentwrap">
                                        ...
                                        <div class="col-md-12">
                                            <div class="travelimp__segmentwrap--btn">
                                                <button type="button" class="btn btn-default asr-viewbtn" onclick="showHideroomcancellationPolicy('roomcancellationPolicy','roomcancellationPolicyButton')" roomcancellationPolicyButton="true"><span>Cancellation Policy</span>&nbsp;<i class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 travelimp__thanku--panelHeadwrap">
                                    <div class="travelimp__thanku--panelHeading">Hotel Rooms Details (<?php echo $hotelInfo['no_of_rooms']; ?>)</div>
                                                    ...
                                                    <?php if ($HotelRoomsDetails) {
                                                        foreach ($HotelRoomsDetails as $roomKey => $HotelRooms) {  ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p>
                                                                        <?php if ($HotelRooms['Amenities']) { ?> Incl : </b><?php foreach ($HotelRooms['Amenities'] as $Amenities) {  ?> <span>
                                                                                    <?php echo  $Amenities; ?>,
                                                                                </span>
                                                                        <?php }
                                                                                                                        }  ?>
                                ...
                                <div class="col-md-12 travelimp__thanku--panelHeadwrap">
                                    ...
                                    <ul class="travelimp__thanku--fareul ">
                                        <li class="travelimp__thanku--fareulborder">
                                            <p class="travelimp__thanku--fareullist"><span><span>Published Price</span></span><span><?php echo defaultCurrency; ?> <?php echo $publishedFare; ?></span></p>
                                        </li>
                                        <li class="travelimp__thanku--fareulborder">
                                            <p class="travelimp__thanku--fareullist"><span><span>Offered Price</span></span><span><?php echo defaultCurrency; ?> <?php echo $offeredFare; ?></span></p>
                                        </li>
                                        <li class="travelimp__thanku--fareulborder">
                                            <p class="travelimp__thanku--fareullist">Comm Earned (-)<span><?php echo defaultCurrency; ?> <?php echo $CommEarned; ?></span></p>
                                        </li>
                                        <?php if ($TDS) : ?>
                                            <li class="travelimp__thanku--fareulborder">
                                                <p class="travelimp__thanku--fareullist">TDS (+)<span><?php echo defaultCurrency; ?> <?php echo $TDS; ?></span></p>
                                            </li>
                                        <?php endif; ?>
                                        <?php if ($couponAmount) : ?>
                                            <li class="travelimp__thanku--fareulborder">
                                                <p class="travelimp__thanku--fareullist">Promocode Discount (-)<span><?php echo defaultCurrency; ?> <?php echo $couponAmount; ?></span></p>
                                            </li>
                                        <?php endif; ?>
                                        <li class="travelimp__thanku--fareulborder">
                                            <p class="travelimp__thanku--fareullist">Total Amount <span><?php echo defaultCurrency; ?> <?php echo ($offeredFare + $TDS - $couponAmount); ?></span></p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-12 travelimp__thanku--panelHeadwrap">
                            ...
                            <?php if ($hotelInfo['booking_status'] == "Confirmed" || $hotelInfo['booking_status'] == "Hold") { ?>
                                <div class="travelimp__thanku--rightside">
                                    <ul class="travelimp__thanku--moreoptions">
                                        <li class="travelimp__thanku--morelist" ng-click="getVoucherInvoiceModel('PrintVoucher')">
                                            <span class="travelimp__thanku--morecontent">Print Voucher</span>
                                            <span class="travelimp__thanku--moreicons fa fa-print"></span>
                                        </li>
                                        <li class="travelimp__thanku--morelist" ng-click="getVoucherInvoiceModel('EmailVoucher')">
                                        ...
                                        <?php if (whitelabel['is_direct_website'] == "inactive") : ?>
                                            ...
                                            <span class="travelimp__thanku--moreicons fa fa-file-alt"></span>
                                                <a class="travelimp__thanku--anchorlink" href="<?php echo  site_url('hotel/get-voucher-invoice?type=AgencyInvoice&booking_ref_number=' . $hotelInfo['booking_ref_number']) ?>">
                                                    
                                                </a>
                                            </li>
                                        <?php endif; ?>
                                        <li class="travelimp__thanku--morelist">
                                            <a class="travelimp__thanku--anchorlink" href="<?php echo  site_url('hotel/get-voucher-invoice?type=CustomerInvoice&booking_ref_number=' . $hotelInfo['booking_ref_number']) ?>">
                    ...
                    <?php if ($hotelInfo['booking_status'] == "Confirmed" || $hotelInfo['booking_status'] == "Hold") { ?>
                        <div class="modal fade " id="HotelInvoiceVoucherOptionModelModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered ">
                                <div class="modal-content modal-content_confirmation ">
                                    ...
                                    <div class="modal-body modal-body_confirmation">
                                        <form action="<?php echo  site_url('hotel/get-voucher-invoice') ?>" method="get" name="printVoucherInvoiceForm">
                                            <input type="hidden" name="booking_ref_number" value="<?php echo $hotelInfo['booking_ref_number']; ?>">
...
<script>
   ...
   /*  var appHotelDetail = angular.module('HotelDetailApp', []); */
    var appHotelDetail = angular.module('ttsApp', []);
