    ...
    <div class="page-content">
        <div class="table_title">
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h5 class="m-0">Hotel Markup</h5>
                    </div>
                    <div class="col-md-8 text-end">
                        <?php if (permission_access("Hotel", "add_hotel_markup")) { ?>
                            <button class="badge badge-wt" view-data-modal="true" data-controller='hotel'
                                data-href="<?php echo site_url('hotel/hotel-markup-view') ?>"><i
                                    class="fa-solid fa-add"></i> Add Hotel Markup
                            </button>
                        <?php } ?>
                        <?php if (permission_access("Hotel", "hotel_markup_status")) { ?>
                            <button class="badge badge-wt" onclick="confirm_change_status('status_change')"><i
                                    class="fa-solid fa-exchange"></i> Change Status
                            </button>
                        <?php } ?>
                        <?php if (permission_access("Hotel", "delete_hotel_markup")) { ?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <!----------Start Search Bar ----------------->
                    <form action="<?php echo site_url('hotel/hotel-markup-list'); ?>" method="GET"
                        class="tts-dis-content row  mb-3" name="markup-search" onsubmit="return searchvalidateForm()">
                        <div class="col-md-2">
                            <div class="form-group form-mb-20">
                                ...
                                <select name="key" class="form-select" onchange="tts_searchkey(this,'markup-search')"
                                    ...
                                    <option value="markup_for" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'markup_for') {
                                                                    echo "selected";
                                                                } ?>>Markup Type
                                    </option>
                        ...
                        <div class="col-md-2">
                            <? if (isset($search_bar_data['key'])): ?>
                                ...
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('hotel/hotel-markup-list'); ?>">Reset
                                        Search</a>
                                </div>
                ...
                <?php
                $trash_uri = "hotel/remove-hotel-markup";
                ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead class="table-active">
                                <tr>
                                    <?php if (permission_access("Hotel", "delete_hotel_markup") || permission_access("Hotel", "hotel_markup_status")) { ?>
                                    ...
                                    <th>Created</th>
                                    <th>Modified</th>
                                    <?php if (permission_access("Hotel", "edit_hotel_markup")) { ?>
                                        <th>Action</th>
                                    <?php } ?>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td><?php echo ucfirst($data['markup_for']); ?></td>
                                            <td><?php echo ucfirst($partner_class); ?></td>

                                            <td><?php echo $data['value']; ?></td>
                                            <td><?php echo ucfirst($data['region_type']); ?></td>

                                            <td>
                                                <?php echo  ucwords(str_replace('_', ' ', $data['hotel_markup_type'])); ?>
                                            </td>
                                            ...
                                            <?php if (permission_access("Hotel", "edit_hotel_markup")) { ?>
                                                <td>
                                                    <a href="javascript:void(0);" view-data-modal="true"
                                                        ...
                                                        data-href="<?php echo site_url('/hotel/edit-admin-hotel-markup-template/') . dev_encode($data['id']); ?>"><i
                                ...
                                <?php }
                                    ...
                                    echo "<tr> <td colspan='11' class='text-center'><b>No  Markup Found</b></td></tr>";
                                } ?>
                            </tbody>
                        </table>
                    </div>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('hotel/hotel-markup-status-change'); ?>" method="post"
                tts-form="true"
