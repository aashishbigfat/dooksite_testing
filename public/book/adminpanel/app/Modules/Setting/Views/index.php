                ...
                <div class="settings-panel">
                    ...
                    <form class="setting-content" name="formlead" action="<?php echo site_url('setting/update_company_setting/' . dev_encode($company_details['id'])); ?>" method="POST" tts-form='true' enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="row pb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group form-mb-20">
                                        ...
                                        <input class="form-control" type="text" name="google_oauth_client_secret" value="<?php echo isset($company_details['google_oauth_client_secret']) ? $company_details['google_oauth_client_secret'] : ""; ?>" placeholder="Google Oauth Client Secret">
                                    </div>


                                    <div class="form-group form-mb-20">
                                        <label class="form-label">Google Oauth Version</label>
                                        <input class="form-control" type="text" name="google_oauth_version" value="<?php echo isset($company_details['google_oauth_version']) ? $company_details['google_oauth_version'] : ""; ?>" placeholder="Google Oauth Version">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-mb-20">
                                     ...
                                     <div class="form-group form-mb-20">
                                        <label class="form-label">Facebook Oauth Client Secret</label>
                                        <input class="form-control" type="text" name="facebook_oauth_app_secret" value="<?php echo isset($company_details['facebook_oauth_app_secret']) ? $company_details['facebook_oauth_app_secret'] : ""; ?>" placeholder="Facebook Oauth Client Secret">
                                    </div>


                                    <div class="form-group form-mb-20">
                                        <label class="form-label">Facebook Oauth Version</label>
                                        <input class="form-control" type="text" name="facebook_oauth_version" value="<?php echo isset($company_details['facebook_oauth_version']) ? $company_details['facebook_oauth_version'] : ""; ?>" placeholder="Facebook Oauth Version">
                                    </div>
                            ...
                            <?php if (isset($whitelable_setting['multi_themes']) && $whitelable_setting['multi_themes'] == 'active') { ?>
                                ...
                                <div class="row gy-2 mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <label class="mt20">
                                                <input type="checkbox" name="default_theme" value="0" class="Lead form-check-input" <?php if ($whitelable_setting['selected_template'] == 0) {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>Default Theme
                                            </label>
                                        </div>
                                                                        ...
                                                                        <div class="card-body p-0">
                                                                            <div class="p-4">
                                                                                <a href="javascript:void(0);" view-data-modal="true" data-controller='webpartner' data-id="<?php echo dev_encode($Website_theme_setting[$x]['id']); ?>" data-href="<?php echo site_url('/setting/website-layout-template-details/') . dev_encode($Website_theme_setting[$x]['id']); ?>">
                                                                                    <img src=" <?php echo root_url . 'uploads/website_template/' . $Website_theme_setting[$x]['image']; ?>" class="card-img mb-3" alt="<?php echo $Website_theme_setting[$x]['title']; ?>" height="200px">
                                                                                </a>
                            ...
                            <div class="row pb-3 ">
                                <div class="col-md-12 ">
                                    <h6 class="view_head">Agent Onboard Security Verification</h6>
                                </div>
                                <div class="col-md-4 mt-20">
                                    <div class="form-group form-mb-20 ">
                                        <label class="switch">
                                            <input type="checkbox" name="whatsapp_number_verify" <?php if ($company_details['whatsapp_verification'] == 'Yes') {
                                                                                                        echo "Checked";
                                                                                                    } ?>>
                                ...
                                <div class="col-md-4 mt-20">
                                    <div class="form-group form-mb-20 ">
                                        <label class="switch">
                                            <input type="checkbox" name="email_verify" <?php if ($company_details['email_verification'] == 'Yes') {
                                                                                            echo "Checked";
                                                                                        } ?>>
                                ...
                                <div class="col-md-4 mt-20">
                                    <div class="form-group form-mb-20 ">
                                        <label class="switch">
                                            <input type="checkbox" name="mobile_number_verify" <?php if ($company_details['mobile_verification'] == 'Yes') {
                                                                                                    echo "Checked";
                                                                                                } ?>>
