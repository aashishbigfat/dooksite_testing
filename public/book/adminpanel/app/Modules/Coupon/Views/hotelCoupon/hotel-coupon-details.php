        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <!-- <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Hotel Coupon  Details</button> -->
            </li>
        </ul>
                ...
                <table class="table table-bordered ">
                    <tbody class="lead_details">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="item-text-value">
                                    ...
                                    $is_domestic = explode(',', $details['region_type']);
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="item-text-value">
                                <?php echo date('d M, Y', (int)$details['check_in_date_from']); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            <?php echo date('d M, Y', (int)$details['check_out_date_to']); ?>
                            </td>
                        </tr>
