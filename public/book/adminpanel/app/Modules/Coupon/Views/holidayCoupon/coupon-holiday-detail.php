        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <!-- <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Holiday Coupon  Details</button> -->
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <table class="table table-bordered ">
                    <tbody class="lead_details">
                        ...
                        <tr>
                            <td><span class=" item-text-head"><b>Holiday Destination</b></span></td>
                            <td>
                                <span class="item-text-value">
                                
                                <?php echo ucfirst($details['destination_name']); ?>
                                </span>
                            </td>
                        </tr>
                      
                        <tr>
                            <td><span class=" item-text-head"><b>Holiday Theme</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo ucfirst($details['theme_name']); ?>
                                </span>
                            </td>
                        </tr>

                        <tr>
                            <td><span class=" item-text-head"><b>Holiday Package</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo ucfirst($details['holiday_package']); ?>
                                </span>
                            </td>
                        </tr>
