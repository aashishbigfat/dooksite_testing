    ...
    <div class="page-content">
        <div class="table_title">
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h5 class="m-0">Holiday Coupon</h5>
                    </div>
                    <div class="col-md-8 text-end">
                        <?php if(permission_access("Coupon", "coupon_holiday_add")) {?>
                   
                            <button class="badge badge-wt" view-data-modal="true" data-controller='flight' data-href="<?php echo site_url('coupon/holiday-coupon-view') ?>"><i class="fa-solid fa-add"></i> Add Holiday Coupon
                            </button>
                            <?php } ?>
            
                            <?php if(permission_access("Coupon", "coupon_holiday_change_status")) {?>
                            <button class="badge badge-wt" onclick="confirm_change_status('status_change')"><i class="fa-solid fa-exchange"></i> Change Status
                            </button>
                            <?php } ?>
                            <?php if(permission_access("Coupon", "coupon_holiday_delete")) {?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <!----------Start Search Bar ----------------->
                    <form action="<?php echo site_url('coupon/holiday-coupon'); ?>" method="GET" class="tts-dis-content row mb-3" name="markup-search" onsubmit="return searchvalidateForm()">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <? if (isset($search_bar_data['key'])) : ?>
                                ...
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('coupon/holiday-coupon'); ?>">Reset
                                        Search</a>
                                </div>
                ...
                <?php
                $trash_uri = "coupon/remove-holiday-coupon";
                ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead class="table-active">
                                <tr>
                                <?php if (permission_access("Coupon", "coupon_holiday_change_status") || permission_access("Coupon", "coupon_holiday_delete")) { ?>
                                    ...
                                    <th>Status</th>
                                    <th>Created</th>
                                    <?php if(permission_access("Coupon", "coupon_holiday_detail_list")) {?>
                                    <th>Action</th>
                                    <?php } ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            data-href="<?php echo site_url('coupon/coupon-holiday-details/') . dev_encode($data['id']); ?>"> <?php echo ucfirst($data['code']); ?></a>
                                            </td>
                                        ...
                                        <td><?php echo $data['destination_name']; ?></td>
                                            ...
                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='coupon'
                                            data-id="<?php echo dev_encode($data['id']); ?>"
                                            data-href="<?php echo site_url('coupon/coupon-holiday-details/') . dev_encode($data['id']); ?>">View</a>
                                            </td>
                                            <?php } ?>
                                ...
                                <?php }
                                    ...
                                    echo "<tr> <td colspan='12' class='text-center'><b>No  Holiday Coupon Found</b></td></tr>";
                                } ?>
                            </tbody>
                        </table>
                    </div>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('coupon/holiday-coupon-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
