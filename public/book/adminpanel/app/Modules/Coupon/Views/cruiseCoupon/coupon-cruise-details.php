        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <!-- <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Cruise Coupon  Details</button> -->
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <table class="table table-bordered ">
                    <tbody class="lead_details">
                        ...
                        <tr>
                            <td><span class=" item-text-head"><b>Cruise Line Name</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo isset($details['cruise_line_name']) ? $details['cruise_line_name'] : 'ANY'; ?>
                                </span>
                            </td>
                        </tr>

                        <tr>
                            <td><span class=" item-text-head"><b>Ship Name</b></span></td>
                            <td>
                                <span class="item-text-value">
                                <?php echo isset($details['ship_name']) ? $details['ship_name'] : 'ANY'; ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td><span class=" item-text-head"><b>Port Name</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo isset($details['port_name']) ? $details['port_name'] : 'ANY'; ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td><span class=" item-text-head"><b>Cabin Name</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo isset($details['cabin_name']) ? $details['cabin_name'] : 'ANY'; ?>
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="item-text-value">
                                <?php echo date('d M, Y', (int)$details['travel_from']); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            <?php echo date('d M, Y', (int)$details['travel_date']); ?>
                            </td>
                        </tr>
