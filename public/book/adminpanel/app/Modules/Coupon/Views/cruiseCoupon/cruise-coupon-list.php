<div class="content ">
   <div class="page-content">
      <div class="table_title">
         <div class="sale_bar">
            <div class="row align-items-center">
               <div class="col-md-4">
                  <h5 class="m-0">Cruise Coupon</h5>
               </div>
               <div class="col-md-8 text-end">
               <?php if (permission_access("Coupon", "add_coupon_cruise")) {  ?>
                  <button class="badge badge-wt" view-data-modal="true" data-controller='cruise' data-href="<?php echo site_url('coupon/cruise-coupon-view') ?>"><i class="fa-solid fa-add"></i> Add Cruise Coupon
                  </button>
                  <?php } ?>
                  <?php if (permission_access("Coupon", "cruise_coupon_status_change")) {  ?>
                  <button class="badge badge-wt" onclick="confirm_change_status('status_change')"><i class="fa-solid fa-exchange"></i> Change Status
                  </button>
                  <?php } ?>
                  <?php if (permission_access("Coupon", "remove_cruise_coupon")) { ?>
      ...
      <div class="card">
         <div class="card-body">
            <!----------Start Search Bar ----------------->
            <form action="<?php echo site_url('coupon/cruise-coupon'); ?>" method="GET" class="tts-dis-content row mb-3" name="markup-search" onsubmit="return searchvalidateForm()">
                        <div class="col-md-2">
                        ...
                        <? if(isset($search_bar_data['key'])): ?>
                            <div class="col-md-2 align-self-center">
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('coupon/cruise-coupon');?>">Reset Search</a>
                                </div>
                            </div>
                        <? endif ?>
            ...
            <!----------End Search Bar ----------------->
            <?php
               $trash_uri = "coupon/remove-cruise-coupon";
               ?>
               ...
               <div class="table-responsive">
                  <table class="table table-bordered table-hover">
                     <thead class="table-active">
                        <tr>
                        <?php if (permission_access("Coupon", "cruise_coupon_status_change") || permission_access("Coupon", "remove_cruise_coupon")) {  ?>
                           ...
                           <th>Status</th>
                           <th>Created</th>
                           <?php if (permission_access("Coupon", "coupon_cruise_Details")) { ?>
                           <th>Action</th>
                           <?php } ?>
                        </tr>
                     </thead>
                     <tbody>
                        ...
                        <?php } ?>
                           ...
                           <td>
                              <a href="javascript:void(0);" view-data-modal="true" data-controller='coupon'
                                 ...
                                 data-href="<?php echo site_url('coupon/coupon-cruise-details/') . dev_encode($data['id']); ?>"><?php echo $data['code']; ?></a>
                              </td>

                           <td>
                           <?php echo isset($data['cruise_line_name']) ? $data['cruise_line_name'] : 'ANY'; ?>
                           </td>
                           <td>
                           <?php echo isset($data['ship_name']) ? $data['ship_name'] : 'ANY'; ?>
                           </td>
                           <td>
                           <?php echo isset($data['port_name']) ? $data['port_name'] : 'ANY'; ?>
                           </td>
                           <td>
                           <?php echo isset($data['cabin_name']) ? $data['cabin_name'] : 'ANY'; ?>
                           </td>
                           ...
                           <td>
                              <a href="javascript:void(0);" view-data-modal="true" data-controller='coupon'
                                 data-id="<?php echo dev_encode($data['id']); ?>"
                                 data-href="<?php echo site_url('coupon/coupon-cruise-details/') . dev_encode($data['id']); ?>">View</a>
                           </td>
                           <?php } ?>
                        ...
                        <?php }
                               ...
                               echo "<tr> <td colspan='14' class='text-center'><b>No Cruise Coupon Found</b></td></tr>";
                           } ?>
                     </tbody>
                  </table>
               </div>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form action="<?php echo site_url('coupon/cruise-coupon-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
