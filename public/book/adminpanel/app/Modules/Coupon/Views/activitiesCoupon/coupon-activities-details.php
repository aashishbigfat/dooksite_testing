        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <!-- <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Activities Coupon  Details</button> -->
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <table class="table table-bordered ">
                    <tbody class="lead_details">
                        ...
                        <tr>
                            <td><span class=" item-text-head"><b>Activities Name</b></span></td>
                            <td>
                                <span class="item-text-value">
                                
                                <?php echo rtrim($details['activities_name'], ','); ?></td>
                                </span>
                            </td>
                        </tr>
                      
                        <tr>
                            <td><span class=" item-text-head"><b>Destination Name</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo rtrim($details['destination_name'], ','); ?></td>
                                </span>
                            </td>
                        </tr>

                        <tr>
                            <td><span class=" item-text-head"><b>Category Name</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo rtrim($details['categories_name'], ','); ?></td>
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="item-text-value">
                                <?php echo date('d M, Y', (int)$details['activity_date_from']); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                            <?php echo date('d M, Y', (int)$details['activity_date_to']); ?>
                            </td>
                        </tr>
