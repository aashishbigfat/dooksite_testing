        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <!-- <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Flight Coupon  Details</button> -->
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <table class="table table-bordered ">
                    <tbody class="lead_details">
                        ...
                        <tr>
                            <td><span class=" item-text-head"><b>Regin Type</b></span></td>
                            <td>
                        ...
                        <tr>
                            <td><span class=" item-text-head"><b>Airline Code</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo ucfirst($details['airline_code']); ?>
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td><span class=" item-text-head"><b>Journey Type</b></span></td>
                            <td><span class="item-text-value">
                            <?php echo ucfirst($details['journey_type']); ?>
                                </span>
                            </td>
                        </tr>
