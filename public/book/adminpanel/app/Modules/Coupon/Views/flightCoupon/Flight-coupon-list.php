    ...
    <div class="page-content">
            ...
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-3 mb-lg-0">
                        <h5 class="m0">Flight Coupon</h5>
                    </div>
                    <div class="col-md-8 text-end">
                        <?php if (permission_access("Coupon", "coupon_flight_add")) {  ?>
                        <button class="badge badge-wt" view-data-modal="true" data-controller='flight' data-href="<?php echo site_url('coupon/flight-coupon-view') ?>"><i class="fa fa-add"></i> Add Flight Coupon
                        </button>
                        <?php } ?>

                        <?php if (permission_access("Coupon", "coupon_flight_change_status")) {  ?>
                        <button class="badge badge-wt" onclick="confirm_change_status('status_change')"><i class="fa fa-exchange"></i> Change Status
                        </button>
                        <?php } ?>
                        <?php if (permission_access("Coupon", "coupon_flight_delete")) { ?>
        ...
        <div class="page-content-area">
            <div class="card-body">
                <div class="row mb_10">
                    <!----------Start Search Bar ----------------->
                    <form action="<?php echo site_url('coupon/flight-coupon'); ?>" method="GET" class="tts-dis-content" name="discount-search" onsubmit="return searchvalidateForm()">
                        <div class="row">
                        <div class="col-md-2">
                            <div class="form-group form-mb-20">
                                ...
                                <select name="key" class="form-select" onchange="tts_searchkey(this,'discount-search')" tts-validatation="Required" tts-error-msg="Please select search key">
                                    ...
                                    <option value="airline_code" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'airline_code') {
                                                                        echo "selected";
                                                                    } ?>>Airline Code</option>
                        ...
                        <div class="col-md-2">
                            <? if (isset($search_bar_data['key'])) : ?>
                                ...
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('coupon/flight-coupon'); ?>">Reset Search</a>
                                </div>
                ...
                <?php
                $trash_uri = "coupon/remove-coupon";
                ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead class="table-active">
                                <tr>
                                 <?php if (permission_access("Coupon", "coupon_flight_change_status") || permission_access("Coupon", "coupon_flight_delete")) {  ?>
                                    ...
                                    <th>Created</th>
                                    <?php if (permission_access("Coupon", "coupon_flight_details_list")) {  ?>
                                    <th>Action</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            data-href="<?php echo site_url('coupon/coupon-flight-details/') . dev_encode($data['id']); ?>"><?php echo ucfirst($data['airline_code']); ?></a>
                                        </td>
                                            <td><?php
                                            ...
                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='coupon'
                                            data-id="<?php echo dev_encode($data['id']); ?>"
                                            data-href="<?php echo site_url('coupon/coupon-flight-details/') . dev_encode($data['id']); ?>"><?php echo ucfirst($data['code']); ?></a>
                                            ...
                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='coupon'
                                            data-id="<?php echo dev_encode($data['id']); ?>"
                                            data-href="<?php echo site_url('coupon/coupon-flight-details/') . dev_encode($data['id']); ?>">View</a>
                                            </td>
                                            <?php } ?>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('coupon/coupon-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
