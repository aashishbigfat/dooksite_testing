<div class="modal-header">
    <h5 class="modal-title" >Add <?= 'Visa Markup '; ?></h5>
    ...
    <form action="<?= site_url('markup-discount/add-super-admin-visa-markup'); ?>" method="post" tts-form="true" name="add_visa_markup">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group form-mb-20">
                        ...
                        <select class="form-control select_search" id="tts-test" tts-method-name="visa/get-visa-list-select" name="visa_country_id" tts-call-select="true">
