<div class="modal-header">
    <h5 class="modal-title" >Edit <?= 'Visa Discount '; ?></h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
    </button>
</div>

   <form action="<?= site_url('markup-discount/edit-admin-visa-discount/') . dev_encode($id); ?>" method="post" tts-form="true"
      ...
      <div class="modal-body">
         <div class="row">
            <div class="col-md-4">
               <div class="form-group form-mb-20">
                  ...
                  <select class="form-control select_search" name="web_partner_class_id[]" multiple="multiple"
                     ...
                     <option value="<?= $class['id'] ?>" <?php if (in_array($class['id'], $details['web_partner_class_id'])) {echo "selected";} ?>   ><?= ucfirst($class['class_name']) ?></option>
                     <?php }
                        } ?>
                  </select>
               </div>
                     ...
                     <select class="form-control select_search" name="visa_type_id[]" tts-call-put-html="true" multiple="multiple">
                         ...
                         if ($visa_list){
                             ...
                             foreach ($visa_list as  $item){ ?>
                                 <option value=<?= $item['id']?> <?php if (in_array($item['id'], $details['visa_type_id'])) {echo "selected";} ?>><?= $item['visa_title']?></option>
                             <?php }
                         }
            ...
            <div class="col-md-4">
               <div class="form-group form-mb-20">
                  <label>Value *</label>
                  <input class="form-control" type="text" value="<?= $details['value'];?>" name="value" placeholder="Value">
               </div>
            </div>
            <div class="col-md-4">
               <div class="form-group form-mb-20">
                  <label>Max Limit </label>
                  <input class="form-control" type="text" value="<?= $details['max_limit'];?>" name="max_limit" placeholder="Max Limit">
               </div>
            </div>
            <div class="col-md-4">
               <div class="form-group form-mb-20">
