    ...
    <div class="page-content">
            ...
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-3 mb-lg-0">
                        <h5 class="m0">Super Admin Hotel Discount</h5>
                    </div>
                    <div class="col-md-8 text-md-right">
                        <?php if (permission_access("CarExtranet", "add_car_discount")) { ?>
                        <button class="badge badge-wt" view-data-modal="true" data-controller='flight'
                                data-href="<?php echo site_url('markup-discount/super-admin-hotel-discount-view') ?>"><i
                                    class="fa-solid fa-add"></i> Add Hotel Discount
                        </button>
                        <?php }?>
                        <?php if (permission_access("CarExtranet", "car_discount_status")) { ?>
                        <button class="badge badge-wt" onclick="confirm_change_status('status_change')"><i
                                    class="fa-solid fa-exchange"></i> Change Status
                        </button>
                        <?php }?>
                        <?php if (permission_access("CarExtranet", "delete_car_discount")) { ?>
        ...
        <div class="page-content-area">
            <div class="card-body">
                <div class="row">
                    <!----------Start Search Bar ----------------->
                    <form action="<?php echo site_url('markup-discount/super-admin-hotel-discount-list'); ?>" method="GET" class="tts-dis-content" name="markup-search" onsubmit="return searchvalidateForm()">
                        <div class="col-md-2">
                        ...
                        <? if(isset($search_bar_data['key'])): ?>
                                ...
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('markup-discount/super-admin-hotel-discount-list');?>">Reset Search</a>
                                </div>
                ...
                <!----------End Search Bar ----------------->
                    ...
                    <?php
                    $trash_uri = "markup-discount/remove-super-admin-hotel-discount";
                    ?>
                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true" id="formmarkuplist">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <?php if (permission_access("CarExtranet", "delete_car_discount") || permission_access("CarExtranet", "car_discount_status")) { ?>
                            ...
                            if (!empty($list) && is_array($list)) {
                                foreach ($list as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <?php if (permission_access("CarExtranet", "edit_car_discount")) { ?>
                                        <td>
                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='hotel' data-id="<?php echo dev_encode($data['id']); ?>" data-href="<?php echo site_url('/markup-discount/edit-admin-hotel-discount-template/') . dev_encode($data['id']); ?>"><i class="fa-solid fa-edit"></i></a>
                                        </td>
                                        <?php }?>
                                    </tr>
                                <?php }
                            } else {
                                echo "<tr> <td colspan='11' class='text_center'><b>No Discount Found</b></td></tr>";
                            } ?>
                            </tbody>
                        </table>
                        </div>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            ...
            <form action="<?php echo site_url('markup-discount/super-admin-hotel-discount-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
