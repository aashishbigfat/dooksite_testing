<div class="modal-header">
    <h5 class="modal-title" >Add <?= 'Visa Discount '; ?></h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
    </button>
</div>
 <form action="<?= site_url('markup-discount/add-super-admin-visa-discount'); ?>" method="post" tts-form="true" name="add_visa_markup">
