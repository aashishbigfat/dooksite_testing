<div class="modal-header">
    <h5 class="modal-title">Edit <?php echo 'Cruise Markup '; ?></h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>

   <form action="<?php echo site_url('markup-discount/edit-admin-cruise-markup/') . dev_encode($id); ?>" method="post" tts-form="true"
