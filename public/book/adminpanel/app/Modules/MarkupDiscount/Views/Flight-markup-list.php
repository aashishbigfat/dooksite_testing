    ...
    <div class="page-content">
            ...
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-3 mb-lg-0">
                        <h5 class="m0"Flight Markup </h5>
                    </div>
                    <div class="col-md-8 text-md-right">
                        <?php //if (permission_access("Flight", "add_flight_markup_b2c")) { ?>
                        <button class="badge badge-wt" view-data-modal="true" data-controller='flight'
                                data-href="<?php echo site_url('markup-discount/flight-markup-view') ?>"><i
                                    class="fa-solid fa-add"></i> Add Flight Markup
                        </button>
                       <!-- <?php /*}*/?>
                        --><?php /*if (permission_access("Flight", "flight_markup_b2c_status")) { */?>
                        <button class="badge badge-wt" onclick="confirm_change_status('status_change')"><i
                                    class="fa-solid fa-exchange"></i> Change Status
                        </button>
                        <?php /*}*/?><!--
                        --><?php /*if (permission_access("Flight", "delete_flight_markup_b2c")) { */?>
        ...
        <div class="page-content-area">
            <div class="card-body">
                <div class="row">
                    <!----------Start Search Bar ----------------->
                    <form action="<?php echo site_url('markup-discount/flight-markup'); ?>" method="GET" class="tts-dis-content" name="markup-search" onsubmit="return searchvalidateForm()">
                        <div class="col-md-2">
                        ...
                        <? if(isset($search_bar_data['key'])): ?>
                                ...
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('markup-discount/flight-markup');?>">Reset Search</a>
                                </div>
                ...
                <!----------End Search Bar ----------------->
                    ...
                    <?php
                    $trash_uri = "markup-discount/remove-markup";
                    ?>
                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true"
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
<!--                                --><?php /*if (permission_access("Flight", "delete_flight_markup_b2c") || permission_access("Flight", "flight_markup_b2c_status")) { */?>
                               ...
                               <!-- --><?php /*}*/?>
                                ...
                                <th>Cabin Class</th>
                                <th>Status</th>
                               <!-- --><?php /*if (permission_access("Flight", "edit_flight_markup_b2c")) { */?>
                                <th>Action</th>
                                <?php /*}*/?>
                            </tr>
                            </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="txt_led_clr" view-data-modal="true"
                                               ...
                                               data-href="<?php echo site_url('markup-discount/flight-markup-details/') . dev_encode($data['id']); ?>"><?php echo $data['airline_code'].' '.'('.$data['airline_name'].')'; ?></a>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <?php /*if (permission_access("Flight", "edit_flight_markup_b2c")) { */?>
                                        <td>
                                            <a href="javascript:void(0);" view-data-modal="true" data-controller='flight' data-id="<?php echo dev_encode($data['id']); ?>" data-href="<?php echo site_url('/markup-discount/edit-markup-template/') . dev_encode($data['id']); ?>"><i class="fa-solid fa-edit"></i></a>
                                        </td>
                                       <!-- --><?php /*}*/?>
                                    </tr>
                                <?php }
                            } else {
                                echo "<tr> <td colspan='11' class='text_center'><b>No Flight Markup Found</b></td></tr>";
                            } ?>
                            </tbody>
                        </table>
                         </div>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('markup-discount/markup-status-change'); ?>" method="post" tts-form="true" name="form_change_status">
