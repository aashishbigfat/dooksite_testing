    ...
    <div class="page-content">
            ...
            <div class="sale_bar">
                <div class="row align-items-center">
                    <div class="col-md-4 mb-3 mb-lg-0">
                        <h5 class="m0">Super Admin Hotel Markup</h5>
                    </div>
                    <div class="col-md-8 text-md-right">
                        <?php if (permission_access("CarExtranet", "add_car_markup")) { ?>
                        <button class="badge badge-wt" view-data-modal="true" data-controller='flight'
                                data-href="<?php echo site_url('markup-discount/super-admin-hotel-markup-view') ?>"><i
                                    class="fa-solid fa-add"></i> Add Hotel Markup
                        </button>
                        <?php }?>
                        <?php if (permission_access("CarExtranet", "car_markup_status")) { ?>
                        <button class="badge badge-wt" onclick="confirm_change_status('status_change')"><i
                                    class="fa-solid fa-exchange"></i> Change Status
                        </button>
                        <?php }?>
                        <?php if (permission_access("CarExtranet", "delete_car_markup")) { ?>
        ...
        <div class="page-content-area">
            <div class="card-body">
                <div class="row">
                    <!----------Start Search Bar ----------------->
                    <form action="<?php echo site_url('markup-discount/super-admin-hotel-markup-list'); ?>" method="GET"
                          class="tts-dis-content" name="markup-search" onsubmit="return searchvalidateForm()">
                        <div class="col-md-2">
                            <div class="form-group form-mb-20">
                                <label>Select key to search by *</label>
                                <select name="key" class="form-control" onchange="tts_searchkey(this,'markup-search')"
                                        tts-validatation="Required" tts-error-msg="Please select search key">
                                    <option value="">Please select</option>

                                    <option value="markup_type" <?php if (isset($search_bar_data['key']) && $search_bar_data['key'] == 'markup_type') {
                                        echo "selected";
                                    } ?> >Markup Type
                                    </option>
                        ...
                        <? if (isset($search_bar_data['key'])): ?>
                                ...
                                <div class="search-reset-btn">
                                    <a href="<?php echo site_url('markup-discount/super-admin-hotel-markup-list'); ?>">Reset
                                        Search</a>
                                </div>
                ...
                <!----------End Search Bar ----------------->
                    ...
                    <?php
                    $trash_uri = "markup-discount/remove-super-admin-hotel-markup";
                    ?>
                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true" id="formmarkuplist">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <?php if (permission_access("CarExtranet", "delete_car_markup") || permission_access("CarExtranet", "car_markup_status")) { ?>
                                ...
                                <th>Created</th>
                                <th>Modified</th>
                                <?php if (permission_access("CarExtranet", "edit_car_markup")) { ?>
                                <th>Action</th>
                                <?php }?>
                            </tr>
                            </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" view-data-modal="true"
                                               ...
                                               data-href="<?php echo site_url('/markup-discount/edit-admin-hotel-markup-template/') . dev_encode($data['id']); ?>"><i
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('markup-discount/super-admin-hotel-markup-status-change'); ?>" method="post"
                  tts-form="true"
