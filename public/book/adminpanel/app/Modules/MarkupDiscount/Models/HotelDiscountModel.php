...
class HotelDiscountModel extends Model
{
    ...
    public function super_admin_hotel_discount_list($web_partner_id)
    {
        return $this->select('web_partner_hotel_discount.*')->where('web_partner_id',$web_partner_id)

            ->orderBy("web_partner_hotel_discount.id", "DESC")->paginate(40);
    }

    public function super_admin_hotel_discount_details($id)
    {
