...
class CruiseMarkupModel extends Model
{
    ...
    public function super_admin_cruise_markup_list($web_partner_id)
    {
        return  $this->select('web_partner_cruise_markup.*')->where('web_partner_id',$web_partner_id)

            ->orderBy("id","DESC")->paginate(40);
    }

    public function super_admin_cruise_markup_details($id)
    {
