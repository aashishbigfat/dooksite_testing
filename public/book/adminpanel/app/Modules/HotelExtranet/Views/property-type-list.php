        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row align-items-center mb-3">
                    <div class="col-md-4">
                        <h5 class="m0">Property Type List</h5>
                    </div>
                    <div class="col-md-8 text-md-end">


                        <?php if (permission_access("HotelExtranet", "add_property")) {  ?>

                            <button class="badge badge-wt" view-data-modal="true" data-controller='cruise'
                                data-href="<?php echo site_url('hotel-extranet/add-property-type-template') ?>">
                                <i class="fa-solid fa-add"></i> Add Property Type
                            </button>
                        <?php }  ?>

                        <?php if (permission_access("HotelExtranet", "status_property")) {  ?>
                            <button class="badge badge-wt" onclick="confirm_change_status('status_change')">
                                <i class="fa-solid fa-exchange"></i> Change Status
                            </button>
                        <?php }  ?>

                        <?php if (permission_access("HotelExtranet", "delete_property")) {  ?>
                ...
                <!----------Start Search Bar ----------------->
                <form action="<?php echo site_url('hotel-extranet/property-type-list'); ?>" method="GET"
                    class="row mb-3"
                    name="cruise-ocean-search" onsubmit="return searchvalidateForm()">
                    <div class="col-md-3">
                    ...
                    <?php if (isset($search_bar_data['key'])): ?>
                        <div class="col-md-3 mb-3">
                            <div class="search-reset-btn">
                                <a href="<?php echo site_url('hotel-extranet/property-type-list'); ?>">Reset
                                    Search</a>
                            </div>
                        </div>
                    <?php endif ?>
                ...
                <div class="col-md-12">
                    ...
                    <?php $trash_uri = "hotel-extranet/remove-property-type"; ?>
                    <form action="<?php echo site_url($trash_uri); ?>" method="POST" tts-form="true" id="formgallerylist">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hpver">
                                <thead class="table-active">
                                    <tr>

                                        <?php if (permission_access("HotelExtranet", "delete_property") || permission_access("HotelExtranet", "status_property")) { ?>
                                        ...
                                        <th>Created Date</th>
                                        <th>Modified Date</th>
                                        <?php if (permission_access("HotelExtranet", "edit_property")) {  ?>
                                            <th>Action</th>
                                        <?php } ?>
                                                ...
                                                <?php if (permission_access("HotelExtranet", "edit_property")) {  ?>
                                                    <td>
                                                        <a href="javascript:void(0);" view-data-modal="true"
                                                            ...
                                                            data-href="<?php echo site_url('hotel-extranet/edit-property-type-template/') . dev_encode($data['id']); ?>"><i class="fa-solid fa-edit "></i></a>
                                                    </td>
                                                <?php } ?>
...
<div id="status_change" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('hotel-extranet/property-type-status-change'); ?>" method="post" tts-form="true"
