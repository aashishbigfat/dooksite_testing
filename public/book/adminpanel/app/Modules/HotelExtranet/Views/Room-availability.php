...
<div class="content">
   <div class="page-content">
      ...
      <div class="sale_bar">
         <div class="row">
            <div class="col-md-4">
               <h5 class="m-0">Room <?php echo 'Availability';  ?></h5>
            </div>
         </div>
      </div>
               ...
               <div class="col-md-12 ">
                  <form name="web-partner" tts-form='true'
                     ...
                     <div style="overflow: auto;">
                        ...
                        $currentMonthDeigit =  date('m');
                        $roomAvailabilitiesIdKeyPair =  array_column($room_availabilities, "month");


                        for ($m =  $currentMonthDeigit; $m <= 12; $m++) {
                           if ($m >= date('m')) {
                              $month = date($m);  // Month
                              ...
                              /* $z = $m - 1; */
                              $z = array_search($monthfull, $roomAvailabilitiesIdKeyPair);
                              ...
                              for ($i = 1; $i <= $no_of_days; $i++) {
                                 ...
                                 $inputval = isset($room_availabilities[$z]["d$i"]) ? $room_availabilities[$z]["d$i"] : 0;
