<?php
    ...
    */
    function _transaction($params, $merchant_key, $salt, $env){
        ...
        // empty validation
        $empty_validation = empty_validation($postedArray, $salt);
        ...
        // type validation
        $type_validation = typeValidation($postedArray, $salt, $env);
    ...
    *  
    */
    if (!function_exists('_checkArgumentValidation')) 
    {
    ...
    *
    */
    if (!function_exists('_removeSpaceAndPreparePostArray')) 
    {
    ...
    */
    ...
    function empty_validation($params, $salt){
        $empty_value = false;
        if(empty($params['key'])) 
    ...
    */
    ...
    function typeValidation($params, $salt, $env){
        $type_value = false;
    ...
    * 
    */
    if (!function_exists('_email_validation')) 
    {
    ...
    */
    function _getTransaction($params_array, $salt_key, $url){
        ...
        $hash_key = getHashKey($params_array, $salt_key);
    ...
    /*
    * getHashKey method generate Hash key based on the API call (initiatePayment API).
    *
    ...
    *
    */
    if (!function_exists('_validateTransactionResponse')) 
    {
    ...
    *
    */
    if (!function_exists('_getReverseHashKey')) 
    {
