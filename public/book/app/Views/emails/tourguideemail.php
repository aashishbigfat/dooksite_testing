...
<?php //echo $name; ?>
        ...
        <table  style="width:700px;border:1px solid rgba(130,130,141,0.44);box-shadow: 0px 0px 3px 0px #ccc;border-radius: 3px;background-color: white;padding: 15px 12px 26px 17px;" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
                <td colspan="2" style="padding:20px 10px 0;font-family:Arial,Helvetica,sans-serif;font-size: 18px;text-align: center;color: #c90000;">New Tour Guide Query Received</td>
            </tr>
            <tr style="">
                <td colspan="2"> 
                    <table class="table table-striped table-hover" style="width:auto; margin-left:41px; margin-top:30px;  font-family:Arial,Helvetica,sans-serif;">
                        ...
                        <?php  if($tour_guide_name !="") { ?>
                        <tr>
                            <td style="font-size: 18px;padding: 11px 19px;border: 1px solid gray;">Tour Guide Name</td>
                            <td style="font-size: 18px;padding: 11px 19px;border: 1px solid gray;"><?php echo $tour_guide_name; ?></td>
                        </tr>
						<?php } ?>
						<?php  if($city_name!="") { ?>
                        <tr>
                            <td style="font-size: 18px;padding: 11px 19px;border: 1px solid gray;">City Name</td>
                            <td style="font-size: 18px;padding: 11px 19px;border: 1px solid gray;"> <?php echo $city_name; ?></td>
                        </tr>
						<?php  } ?>
