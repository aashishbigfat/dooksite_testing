<section class="payment-section p-4">
   <div class="container">
      <div class="row">
         <div class="col-lg-8 col-12 col-md-12 mb-3 mb-lg-0">
               ...
               <div class="card-body p-0">
                  <div class="d-flex align-items-start">
                     <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <?php $web_partner_wallet_balance = get_balance();
                        if ($web_partner_wallet_balance > $total_price && isset(session()->get('wl_customer')['id']) && 0) { ?>
                           <button class="nav-link  <?php if ($web_partner_wallet_balance > $total_price) {
                                                         echo  "active";
                                                      } ?>" id="my-wallet-tab" data-bs-toggle="tab" data-bs-target="#my-wallet" type="button" role="tab" aria-controls="my-wallet" aria-selected="false">My Wallet
                           </button>
                        <?php } ?>
                        <button class="nav-link <?php if ($web_partner_wallet_balance < $total_price || !isset(session()->get('wl_customer')['id']) || 1) {
                                                   echo  "active";
                                                } ?>" id="credit-card-tab" data-bs-toggle="pill" data-bs-target="#credit-card" type="button" role="tab" aria-controls="credit-card" aria-selected="true">Credit Card
                        </button>
                        <button class="nav-link" id="debit-card-tab" data-bs-toggle="pill" data-bs-target="#debit-card" type="button" role="tab" aria-controls="debit-card" aria-selected="false">Debit Card
                        </button>
                        <button class="nav-link" id="net-banking-tab" data-bs-toggle="pill" data-bs-target="#net-banking" type="button" role="tab" aria-controls="net-banking" aria-selected="false">Net Banking
                        </button>
                        <button class="nav-link" id="mob-wallet-tab" data-bs-toggle="pill" data-bs-target="#mob-wallet" type="button" role="tab" aria-controls="mob-wallet" aria-selected="false">Mobile Wallets
                        </button>
                        <button class="nav-link border-bottom-0" id="upi-payment-tab" data-bs-toggle="pill" data-bs-target="#upi-payment" type="button" role="tab" aria-controls="upi-payment" aria-selected="false">Upi Payment
                        </button>
                     </div>
                     <div class="tab-content p-3" id="v-pills-tabContent">
                        <div class="tab-pane fade <?php if ($web_partner_wallet_balance > $total_price && isset(session()->get('wl_customer')['id']) && 0) {
                                                      echo  "show active";
                                                   } ?>" id="my-wallet" role="tabpanel" aria-labelledby="my-wallet-tab">
                           <?php $wallet_balance = get_balance_wl_customer();
                           ...
                           <?php if ($wallet_balance >= $total_price) { ?>
                              <form action="<?php echo site_url('payment/flight-proceed-payment/'); ?><?php echo $walletpayment_token; ?>" id="mywallet-form">
                                 <p class="mb-4 ml-0"><b>Please note:</b> By placing this order, you agree to
                                    our Terms Of Use and Privacy Policy
                                 </p>
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="mywallet-terms">
                                    <label class="form-check-label" for="mywallet-terms">I accept <a href="" title="terms and conditions">
                                          terms and conditions</a> and <a href="" title="privacy policy">
                                          privacy policy </a>.</label>
                                 </div>
                                 <button type="button" class="btn btn-danger" onclick="continue_payment(this,'mywallet-terms','mywallet-form')">
                                    Pay Now ₹ <?php echo number_format_value($total_price); ?> </button>
                              </form>
                           <?php } else {
                              echo "<h5 class='text-danger'> Your wallet do not have sufficient balance</h5>";
                           } ?>
                        </div>
                        <div class="tab-pane fade <?php if ($web_partner_wallet_balance < $total_price ||  !isset(session()->get('wl_customer')['id']) || 1) {
                                                      echo  "show active";
                           ...
                           ?>
                           <form action="<?php echo site_url('payment/flight-proceed-payment/'); ?><?php echo $creditpayment_token_visa; ?>" id="credit-card-form">
                              ...
                              <?php if (trim(whitelabel['payment_gateway_name']) == "Default") { ?>
                              ...
                              <?php } ?>
                              <p>Payment Fee :
                                 ₹ <span id="tts-conveniencefee"><?php echo number_format_value($credit_data['conveniencefee']); ?></span>
                              </p>
                              <div class="form-check">
                                 <input class="form-check-input" type="checkbox" value="" id="credit-card-terms">
                                 <label class="form-check-label" for="credit-card-terms">I accept <a href="" title="terms and conditions">
                                       terms and conditions</a> and <a href="" title="privacy policy">
                                       privacy policy </a>.</label>
                              </div>
                              <button type="button" class="btn btn-danger" onclick="continue_payment(this,'credit-card-terms','credit-card-form')">
                                 Pay Now
                        ...
                        <div class="tab-pane fade" id="debit-card" role="tabpanel" aria-labelledby="debit-card-tab">
                           <?php
                           ...
                           ?>
                           <form action="<?php echo site_url('payment/flight-proceed-payment/'); ?><?php echo $debitpayment_token; ?>" id="debit-card-form">
                              <p class="mb-4"><b>Please note:</b> You may be redirected to bank page to
                                 complete your transaction. By making this booking, you agree to our Terms of
                                 Use and Privacy Policy.
                              </p>
                              <p>Payment Fee :
                                 ₹<?php echo number_format_value($debit_data['conveniencefee']); ?>
                              </p>
                              <div class="form-check">
                                 <input class="form-check-input" type="checkbox" value="" id="debit-card-terms">
                                 <label class="form-check-label" for="debit-card-terms">I accept <a href="" title="terms and conditions">
                                       terms and conditions</a> and <a href="" title="privacy policy">
                                       privacy policy </a>.</label>
                              </div>
                              <button type="button" class="btn btn-danger" onclick="continue_payment(this,'debit-card-terms','debit-card-form')">
                                 Pay Now
                        ...
                        <div class="tab-pane fade" id="net-banking" role="tabpanel" aria-labelledby="net-banking-tab">
                           ...
                           ?>
                           <form action="<?php echo site_url('payment/flight-proceed-payment/'); ?><?php echo $netpayment_token; ?>" id="net-baning-form">
                              <p class="mb-4"><b>Please note:</b> You may be redirected to bank page to
                                 complete your transaction. By making this booking, you agree to our Terms of
                                 Use and Privacy Policy.
                              </p>
                              <p>Payment Fee :
                                 ₹<?php echo number_format_value($net_banking_data['conveniencefee']); ?>
                              </p>
                              <div class="form-check">
                                 <input class="form-check-input" type="checkbox" value="" id="net-baning-terms">
                                 <label class="form-check-label" for="net-baning-terms">I accept <a href="" title="terms and conditions">
                                       terms and conditions</a> and <a href="" title="privacy policy">
                                       privacy policy </a>.</label>
                              </div>
                              <button type="button" class="btn btn-danger" onclick="continue_payment(this,'net-baning-terms','net-baning-form')">
                                 Pay Now
                                 ₹<?php echo number_format_value($net_banking_data['totalfare']); ?></button>
                           </form>
                        </div>
                        <div class="tab-pane fade" id="mob-wallet" role="tabpanel" aria-labelledby="mob-wallet-tab">
                           ...
                           ?>
                           <form action="<?php echo site_url('payment/flight-proceed-payment/'); ?><?php echo $mob_paymentdata; ?>" id="mob-wallet-form">
                              <p class="mb-4"><b>Please note:</b> You may be redirected to bank page to
                                 complete your transaction. By making this booking, you agree to our Terms of
                                 Use and Privacy Policy.
                              </p>
                              <p>Payment Fee :
                                 ₹<?php echo number_format_value($mob_wallet_data['conveniencefee']); ?>
                              </p>
                              <div class="form-check">
                                 <input class="form-check-input" type="checkbox" value="" id="mob-wallet-terms">
                                 <label class="form-check-label" for="mob-wallet-terms">I accept <a href="" title="terms and conditions">
                                       terms and conditions</a> and <a href="" title="privacy policy">
                                       privacy policy </a>.</label>
                              </div>
                              <button type="button" class="btn btn-danger" onclick="continue_payment(this,'mob-wallet-terms','mob-wallet-form')">
                                 Pay Now
                                 ₹<?php echo number_format_value($mob_wallet_data['totalfare']); ?></button>
                           </form>
                        </div>
                        <div class="tab-pane fade" id="upi-payment" role="tabpanel" aria-labelledby="upi-payment-tab">
                           <?php $mob_wallet_data = calculate_convenience_fee($convenience_fee_list, 'mobile_wallet', $total_price);
                           ...
                           ?>
                           <form action="<?php echo site_url('payment/flight-proceed-payment/'); ?><?php echo $mob_paymentdata; ?>" id="upi-payment-form">
                              <p class="mb-4"><b>Please note:</b> You may be redirected to bank page to
                                 complete your transaction. By making this booking, you agree to our Terms of
                                 Use and Privacy Policy.
                              </p>
                              ...
                              <div class="form-check">
                                 <input class="form-check-input" type="checkbox" value="" id="upi-payment-terms">
                                 <label class="form-check-label" for="upi-payment-terms">I accept <a href="" title="terms and conditions">
                                       terms and conditions</a> and <a href="" title="privacy policy">
                                       privacy policy </a>.</label>
                              </div>
                              <button type="button" class="btn btn-danger" onclick="continue_payment(this,'upi-payment-terms','upi-payment-form')">
                                 Pay Now
                                 ₹<?php echo number_format_value($mob_wallet_data['totalfare']); ?></button>
                           </form>
                        </div>
         ...
         <?php if ($booking_data) { ?>
            <div class="col-lg-4 col-12 col-md-12 mb-3 mb-lg-0">
               <div class="payment-title ">
                  ...
                  <div class="card-body booking-summary-card">
                     ...
                     foreach ($booking_data as $journeykey => $bookingData) {
                        ...
                        if (isset($fareBreakupArray['WebPDisplayMarkup']) && $fareBreakupArray['WebPDisplayMarkup'] == 'in_service_charge') {
                           $WebPDisplayMarkup = $fareBreakupArray['WebPDisplayMarkup'];
                        ...
                        if ($bookingData['coupon_info'] != NULL) {
                           $coupounInfo = json_decode($bookingData['coupon_info'], true);
                           $couponAmount = $coupounInfo['couponAmount'];
                           $FareBreakUp['FareBreakup']['Promocode'] = array("Value" => round_value($couponAmount), "LabelText" => "Promocode Discount (-)");
                        }
                        $FareBreakUp['FareBreakup']['TotalAmount'] = array("Value" => $fareBreakupArray['PublishedPrice'] + $markup - $discount, "LabelText" => "Pay  Amount");
               ...
               <?php if ($FareBreakUpDataArray) {
                  foreach ($FareBreakUpDataArray  as $farejourneykey => $FareBreakUpData) { ?>
...
<style>
   ...
   .nav-pills .nav-link.active {
      border-left: 2px solid var(--second-bolor);
      color: var(--second-bolor);
      border-radius: 0;
