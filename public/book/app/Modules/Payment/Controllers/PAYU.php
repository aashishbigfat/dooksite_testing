...
class PAYU extends BaseController
{
    ...
    public function response($response)
    {
        ...
        $PaymentModel = new PaymentModel();
        $paymentrecord = $PaymentModel->checkpayment_record($this->transaction_table, ['order_id' =>$txnid, 'payment_status' => 'Processing','web_partner_id'=>$this->web_partner_id]);
        ...
        return array('payment_status' => $payment_status, 'order_id' => $txnid, 'amount' => $orderAmount);
            ...
            return array('ErrorCode' => 4001, 'ErrorMessage' => 'Unauthorized request detected', 'order_id' =>$txnid);
        } 
