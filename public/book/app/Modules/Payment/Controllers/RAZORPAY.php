...
class RAZORPAY extends BaseController
{
    ...
    public function response($response)
    {
        ...
        $PaymentModel = new PaymentModel();
        $paymentrecord = $PaymentModel->checkpayment_record($this->transaction_table, ['order_id' => $response['razorpay_order_id'], 'payment_status' => 'Processing','web_partner_id'=>$this->web_partner_id]);
        ...
        if (!empty($paymentrecord)) {
            ...
            return array('ErrorCode' => 4001, 'ErrorMessage' => 'Unauthorized request detected', 'order_id' => $response['razorpay_order_id']);
        }
