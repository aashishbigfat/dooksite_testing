    ...
    public function proceed_payment()
    {
        ...
        if ($payment_mode == 'wallet') {
            ...
            if (empty($paymentrecord)) {
                ...
                $payable_amount += $convenience_fee;
    ...
    protected function FlightWallet($booking_ids, $paymentInfo, $paymentBy, $paymentRequest)
    {
        ...
        if ($paymentBy == "Wallet") {
            ...
            foreach ($booking_data as $bookingInfo) {
                ...
                $Currencyinfor['currency_rate'] = isset($bookingInfo['currency_rate']) ? $bookingInfo['currency_rate'] : 1;
    ...
    public function response()
    {
        ...
        if ($method == 'POST' || $method == 'GET') {
            ...
            if ($payment_response['payment_status'] == 'Successful') {
                ...
                $amount = $payment_request['actually_amounts'] - $payment_request['convenience_fee'];
                if ($this->payment_gateway_type == "superadmin") {
                    $walletbalance = get_balance();
                ...
                $customerbalance = $customerwalletbalance + $amount;
