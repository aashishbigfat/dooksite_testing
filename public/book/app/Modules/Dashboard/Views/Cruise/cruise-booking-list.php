                ...
                <div class="BookingStatusWrapper">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><i class="fa fa-suitcase"></i> Upcomingcheck-Ins
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="BookingStatusWrappertabs">
                    <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Cruise Line Name</th>
                                                <th scope="col">Ship Name</th>
                                                <th scope="col">Sailing Date</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('/cruise/confirmation/') . $ticketData = dev_encode(json_encode(array("BookingId" => $data['id'], "BookingToken" => $data['tts_search_token']))); ?>" target="_blank"><?php echo $data['booking_ref_number']; ?></a>
                                                        </td>

                                                        <td><?php echo ucfirst($data['cruise_line_name']); ?></td>
                                                        <td><?php echo $data['ship_name']; ?></td>
                                                        <td><?php echo display_custom_date_format($data['sailing_date']); ?></td>
                                                        ...
                                                        <td> &#x20b9 <?php echo $data['total_price']; ?></td>
                                                        <td>
                        ...
                        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                            <div class="row">
                                <div class="col-lg-3">
                                    <img src="<?php echo site_url('webroot/img/upcoming-empty.png') ?>" class="img-fluid">
                                </div>
                                <div class="col-lg-9 text-start">
                                    <p class="emptyErr--heading">Looks empty, you've no upcoming bookings.</p>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('cruise/confirmation/') . dev_encode(json_encode(array($data['Booking_id']))); ?>" target="_blank"><?php echo $data['booking_ref_number']; ?></a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('/cruise/amendments-details/') . $ticketData = dev_encode($data['id']); ?>" target="_blank"><i class="tts-icon eye"> View</i></a>
                                                        </td>
                                                    </tr>
                                            <?php }
                                            } else {
...
<div class="modal fade" id="raise-amendment-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="raise-amendment-modalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('cruise/raise-amendment'); ?>" method="post" tts-form="true" name="cruise-raise-amendment">
