                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="all-Amendments-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="all-Amendments" aria-selected="false">Amendments
                            </button>
                        </li>
                    </ul>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('flight/confirmation/') . dev_encode(json_encode(array($data['id']))); ?>"
                                                        ...
                                                        <?php if ($data['booking_status'] != "Cancelled" && $data['booking_status'] != "Processing") { ?>
                                                            <td>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('flight/confirmation/') . dev_encode(json_encode(array($data['flightBokkingid']))); ?>"
                                                                target="_blank"><?php echo $data['booking_ref_number']; ?></a>
                                                        </td>
            ...
            <form action="<?php echo site_url('flight/raise-amendment'); ?>" method="post"
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="booking_ref_number" tts-booking-ref-no="true"
