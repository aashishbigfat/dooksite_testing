                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('/holiday/confirmation/') . dev_encode(json_encode(array("BookingId" => $data['id']))); ?>"
                                                                target="_blank"><?php echo $data['booking_ref_number']; ?></a>
                                                        </td>
                                                        <td><?php echo $data['package_name']; ?></td>
                                                        <td><?php echo $data['day_nights']; ?></td>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($amendment_list) && is_array($amendment_list)) {
                                                foreach ($amendment_list as $data) {
                                                    ...
                                                    $ticketData = dev_encode(json_encode(array("BookingId" => $data['booking_ref_no'])));
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('holiday/confirmation/' . $ticketData); ?>"
                                                                target="_blank"><?php echo $data['booking_ref_number']; ?></a>
                                                        ...
                                                        <td><?php echo ucwords($data['package_name']); ?></td>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('/holiday/amendments-details/') . $ticketData = dev_encode($data['id']); ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-6 text-start">
                                                <p class="pagiantion_text">Page <?= $amendment_pager->getCurrentPage() ?>
                                                    of <?= $amendment_pager->getPageCount() ?>, total
...
<div class="modal fade" id="raise-amendment-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('holiday/raise-amendment'); ?>" method="post" tts-form="true"
