                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('/bus/details/') . $data['booking_ref_number']; ?>"
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('/bus/amendments-details/') . $ticketData = dev_encode($data['id']); ?>"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bus-raise-amendmentLabel">AMENDMENTS</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?php echo site_url('bus/raise-amendment'); ?>" method="post" tts-form="true"
