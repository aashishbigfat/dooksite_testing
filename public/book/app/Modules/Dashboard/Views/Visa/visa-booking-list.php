                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('/visa/confirmation/') . dev_encode(json_encode(array("BookingId" => $data['id']))); ?>"
                                                                target="_blank"><?php echo $data['booking_ref_number']; ?></a>
                                                        </td>
                                                        <td><?php echo $data['visa_country']; ?></td>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('/visa/confirmation/') . dev_encode(json_encode(array("BookingId" => $data['booking_ref_no']))); ?>"
                                                                target="_blank"><?php echo $data['booking_ref_number']; ?></a>
                                                        </td>
...
<div class="modal fade" id="raise-amendment-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('visa/raise-amendment'); ?>" method="post" tts-form="true"
