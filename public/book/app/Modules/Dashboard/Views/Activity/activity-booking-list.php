                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('activities/confirmation/') . dev_encode(json_encode(array('BookingId' => $data['id']))); ?>" target="_blank">
                                                                <?php echo $data['booking_ref_number']; ?>
                                                            </a>
                                                        </td>

                                                        <td>
                                                            <?php echo ucfirst($data['activity_name']); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo display_custom_date_format($data['book_date']); ?>
                                                        </td>
                                                        <td>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('activities/confirmation/') . dev_encode(json_encode(array('BookingId' => $data['BookingId']))); ?>" target="_blank"> <?php echo $data['booking_ref_number']; ?> </a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('/activities/amendments-details/') . $ticketData = dev_encode($data['id']); ?>" target="_blank"><i class="tts-icon eye"> View</i></a>
                                                        </td>
                                                    </tr>
                                            <?php }
                                            } else {
...
<div class="modal fade" id="raise-amendment-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="raise-amendment-modalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('activities/raise-amendment'); ?>" method="post" tts-form="true" name="flight-raise-amendment">
