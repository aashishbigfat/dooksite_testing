            ...
            <div class="col-lg-9">
                <div class="BookingStatusWrapper">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="all-amendment-tab" data-bs-toggle="pill"
                                data-bs-target="#all-amendment" type="button" role="tab" aria-controls="all-amendment"
                                aria-selected="false">Amendment List
                            </button>
                        </li>
                    </ul>
                ...
                <div class="BookingStatusWrappertabs">
                    <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('car/confirmation/') . $ticketData = dev_encode(json_encode(array("id" => $data['id'], "BookingToken" => $data['tts_search_token']))) ?> "
                        ...
                        <div class="tab-pane fade" id="all-amendment" role="tabpanel" aria-labelledby="all-Bookings-tab"
                            tabindex="0">
                            <?php if (!empty($amendment_list)) { //pr($amendment_list);exit; 
                            ?>
                                <div class="table-responsive-md">
                                    <table class="table table-bordered">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr scope="row">
                                                        <td>
                                                            <a href="<?php echo site_url('car/confirmation/') . $ticketData = dev_encode(json_encode(array("id" => $data['booking_ref_no'], "BookingToken" => $data['tts_search_token']))) ?> "
                                                                target="_blank"><?php echo $data['booking_ref_number']; ?></a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <span class="<?php echo $amendment_status ?>">
                                                                <?php echo ucfirst($data['amendment_status']); ?></span>
                                                        </td>

                                                        <td><?php echo ucwords($data['car_name']); ?></td>
                                                        <td><?php echo ucwords($data['car_type']); ?></td>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('/car/amendments-details/') . $ticketData = dev_encode($data['id']); ?>"
...
<div class="modal fade" id="raise-amendment-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('car/raise-amendment'); ?>" method="post" tts-form="true"
                name="hotel-raise-amendment">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="booking_ref_number" tts-booking-ref-no="true" value=""
