...
namespace App\Modules\Dashboard\Models\Hotel;
...
class HotelBookingModel extends Model
{
    ...
    public function hotel_booking_list_all($web_partner_id,$wl_customer_id,$userType)
    {
        return  $this->select('hotel_booking_list.id,hotel_booking_list.booking_ref_number,hotel_booking_list.city,hotel_booking_list.check_in_date,
        hotel_booking_list.check_out_date,hotel_booking_list.no_of_rooms,hotel_booking_list.created,hotel_booking_list.country_code,hotel_booking_list.hotel_name,hotel_booking_list.default_currency,hotel_booking_list.booking_currency,hotel_booking_list.currency_rate,
        hotel_booking_list.confirmation_no,hotel_booking_list.payment_status,hotel_booking_list.booking_status,hotel_booking_list.total_price,
        hotel_booking_list.agent_staff_id,hotel_booking_list.last_cancellation_date,hotel_booking_list.lead_passenger_name,hotel_booking_list.booking_channel,
        CONCAT(admin_users.first_name," ",admin_users.last_name) as staff_name')
            ->where(['hotel_booking_list.web_partner_id' => $web_partner_id,'hotel_booking_list.wl_customer_id'=>$wl_customer_id,'hotel_booking_list.booking_source'=>$userType])
    ...
    public function hotel_booking_upcomming_list($web_partner_id,$wl_customer_id,$userType)
    {
        $year = date('Y');
        $month = date('m');
        return  $this->select('hotel_booking_list.id,hotel_booking_list.booking_ref_number,hotel_booking_list.city,hotel_booking_list.check_in_date,
        ...
        hotel_booking_list.agent_staff_id,hotel_booking_list.last_cancellation_date,hotel_booking_list.lead_passenger_name,hotel_booking_list.booking_channel,
        CONCAT(admin_users.first_name," ",admin_users.last_name) as staff_name')
            ->where("MONTH(hotel_booking_list.check_in_date) = {$month} AND YEAR(hotel_booking_list.check_in_date) >= {$year}")
            ->where(['hotel_booking_list.web_partner_id' => $web_partner_id,'hotel_booking_list.wl_customer_id'=>$wl_customer_id,'hotel_booking_list.booking_source'=>$userType,'hotel_booking_list.booking_status'=>'Confirmed'])
            ->join("admin_users","admin_users.id=hotel_booking_list.agent_staff_id",'left')
            ->orderBy("hotel_booking_list.id","DESC")->paginate(40);
    }


    public function hotel_booking_cancelled_list($web_partner_id,$wl_customer_id,$userType)
    {
        ...
        hotel_booking_list.agent_staff_id,hotel_booking_list.last_cancellation_date,hotel_booking_list.lead_passenger_name,hotel_booking_list.booking_channel,
        CONCAT(admin_users.first_name," ",admin_users.last_name) as staff_name')
            ->whereIn('hotel_booking_list.booking_status',['Cancelled','PartialCancelled'])
            ->where(['hotel_booking_list.web_partner_id' => $web_partner_id,'hotel_booking_list.wl_customer_id'=>$wl_customer_id,'hotel_booking_list.booking_source'=>$userType])
            ->join("admin_users","admin_users.id=hotel_booking_list.agent_staff_id",'left')
            ->orderBy("hotel_booking_list.id","DESC")->paginate(40);
    }
    ...
    function search_data($data)
    {
        if ($data['from_date'] && $data['to_date']) {
            ...
            if ($data['key'] == 'date-range') {
                ...
                return  $this->select('hotel_booking_list.id,hotel_booking_list.booking_ref_number,hotel_booking_list.city,hotel_booking_list.check_in_date,hotel_booking_list.check_out_date,hotel_booking_list.no_of_rooms,hotel_booking_list.created,hotel_booking_list.country_code,hotel_booking_list.hotel_name,hotel_booking_list.confirmation_no,hotel_booking_list.payment_status,hotel_booking_list.booking_status,hotel_booking_list.total_price,hotel_booking_list.agent_staff_id,hotel_booking_list.last_cancellation_date,hotel_booking_list.default_currency,hotel_booking_list.booking_currency,hotel_booking_list.currency_rate,hotel_booking_list.lead_passenger_name,hotel_booking_list.booking_channel,CONCAT(admin_users.first_name," ",admin_users.last_name) as staff_name')
                ->join("admin_users","admin_users.id=hotel_booking_list.agent_staff_id",'left')
                    ->where($array)
                    ->orderBy("hotel_booking_list.id","DESC")->paginate(40);
            ...
            return  $this->select('hotel_booking_list.id,hotel_booking_list.booking_ref_number,hotel_booking_list.city,hotel_booking_list.check_in_date,hotel_booking_list.check_out_date,hotel_booking_list.no_of_rooms,hotel_booking_list.created,hotel_booking_list.country_code,hotel_booking_list.hotel_name,hotel_booking_list.confirmation_no,hotel_booking_list.payment_status,hotel_booking_list.booking_status,hotel_booking_list.default_currency,hotel_booking_list.booking_currency,hotel_booking_list.currency_rate,hotel_booking_list.total_price,hotel_booking_list.agent_staff_id,hotel_booking_list.last_cancellation_date,hotel_booking_list.lead_passenger_name,hotel_booking_list.booking_channel,CONCAT(admin_users.first_name," ",admin_users.last_name) as staff_name')
            ->join("admin_users","admin_users.id=hotel_booking_list.agent_staff_id",'left')
