				...
				<div class="sale_bar">
					<div class="tts_row">
						...
						<div class="tts-col-6 text_right">
							<a class="btn btn-sm btn-info text-white" href="<?php echo site_url('/flight/confirmation/') . $ticketData = dev_encode(json_encode(array($bookingDetail['flightbookingid']))); ?>" target  =  "_blank">Booking Summary</a>
						</div>
					</div>
				</div>
										...
										<div class="cart-details-borderline">
											<div class="row">
												<div class="row">
													...
													<div class="col-md-4 col-xs-6">
														<div class="cart_info-field">
															<p class="cart_info-field--title">Amendment Type :<span class="cart_info-field--detail"><span> &nbsp;<?php echo ucfirst(str_replace("_"," ",$bookingDetail['amendment_type'])); ?></span></span>
															</p>
														</div>
													</div>
											...
											<?php if (isset($bookingDetail['segments'])) {
												...
												foreach ($tripInfo as $key => $trips) {
													if ($trips) { 
														...
														?>
                                                      <div class="row segment_header-top"><div class  =  "col-md-12"> <span class=""><?php echo $firstSegment['Origin']['CityName']  ?></span>-><span><?php echo $lastegment['Destination']['CityName']  ?></span><span class="margin-left">on <?php echo get_flight_date($firstSegment['Origin']['DepartTime']); ?></span></div></div>
      ...
      <div class="col-md-4 col-xs-6">
         <div class="passenger_list-details">
            <div class="passenger_list-details-fix-box">
               <div class="hidden">
               <p class="pax-name no_margin"> <?php echo $traveler['title']." ".$traveler['first_name']." ".$traveler['last_name']; ?>  (<?php echo $traveler['pax_type'] ?>)<span class="tooltip-keys"></span></p>
            </div>
         </div>
      </div>
   </div>
