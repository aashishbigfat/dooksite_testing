<div style="width: 100%; height: auto; background: #bbbdc0; margin: auto; padding-top: 50px; padding-bottom: 50px;">
	<center style="width: 850px;  height: auto; position: relative; background: #fff; margin: auto;   box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); font-family: 'Poppins', sans-serif; padding: 20px">
		<table style=" text-align: left; width:100%; border-collapse: collapse; ">
			<tr>
				<td>
					<h5 style="margin-bottom:20px; margin-top:20px; text-align: center; text-transform: capitalize; font-size: 15px;">Tax Invoice</h5>
				</td>
			</tr>
		</table>
		...
		<table style=" text-align: left; float: left;  width:50%; border-collapse: collapse; border: 1px solid #ddd;">
			<tr>
				<th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">Invoice Date :</th>
				<td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px; "><?php echo $InvoiceDate; ?></td>
			</tr>

		</table>
		<table style=" text-align: left; float: left;  width:50%; border-collapse: collapse; border: 1px solid #ddd;">
			<tr>
				<th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">Booking Reference number :</th>
				<td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px; "><?php echo $BookingRefNumber; ?></td>
			</tr>

		</table>
		<table style=" text-align: left; float: left;  width:50%; border-collapse: collapse; border: 1px solid #ddd;">
			<tr>
				<th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">Booking Date :</th>
				<td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px; "><?php echo $BookingDate; ?></td>
			</tr>

		</table>
		<table style=" text-align: left; float: left;  width:50%; border-collapse: collapse; border: 1px solid #ddd;">
			<tr>
				<th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">Trip Type :</th>
				<td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px; "><?php echo $JourneyType; ?></td>
			</tr>

		</table>
		<table style=" text-align: left;   width:50%; border-collapse: collapse; border: 1px solid #ddd;">
			<tr>
				<th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">GDS/Airline PNR :</th>
				<td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px;"><?php echo $Pnr; ?></td>
			</tr>

		</table>

		<table style=" text-align: left;  width:100%; border-collapse: collapse; border: 1px solid #ddd;">
			<h5 style="margin-bottom:20px; margin-top: 20px; text-align: left; text-transform: uppercase; font-size: 15px;font-weight: 600; "> Passenger Details</h5>
			<tr>
				<th style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px; border-bottom:1px solid #ccc">Ticket No</th>
				<th style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px; border-bottom:1px solid #ccc">Sectors</th>
				<th style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px; border-bottom:1px solid #ccc">Passenger Name</th>
				...
				<th style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px; border-bottom:1px solid #ccc"> Service Charges</th>
				<th style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px; border-bottom:1px solid #ccc"> Meal Charges</th>
				<th style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px; border-bottom:1px solid #ccc"> Baggage Charges</th>
			</tr>
			<?php if ($TicketInvoiceData) {
				foreach ($TicketInvoiceData as $InvoiceData) {
					foreach ($InvoiceData['TravelersInfo'] as $Travelers) { ?>
						<tr>
							<td style="  padding: 5px 7px; text-align: left; font-weight: normal; font-size:13px;"><?php echo $Travelers['ticket_number']; ?></td>
							<td style="  padding: 5px 7px; text-align: left; font-weight: normal; font-size:13px;"><?php echo $InvoiceData['Origin'] . "-" . $InvoiceData['Destination']; ?></td>
							...
							<td style="  padding: 5px 7px; text-align: left; font-weight: normal; font-size:13px;"><?php echo $Travelers['fare']['BaseFare']; ?></td>
							<td style="  padding: 5px 7px; text-align: left; font-weight: normal; font-size:13px;"><?php echo $Travelers['fare']['Tax']; ?></td>
							<td style="  padding: 5px 7px; text-align: left; font-weight: normal; font-size:13px;"><?php echo $Travelers['fare']['YQTax']; ?></td>
							<td style="  padding: 5px 7px; text-align: left; font-weight: normal; font-size:13px;"><?php echo $Travelers['fare']['ServiceCharges']; ?></td>
							<td style="  padding: 5px 7px; text-align: left; font-weight: normal; font-size:13px;"><?php echo $Travelers['fare']['MealCharges']; ?></td>
							<td style="  padding: 5px 7px; text-align: left; font-weight: normal; font-size:13px;"><?php echo $Travelers['fare']['BaggageCharges']; ?></td>
						</tr>
					<?php }
				}
			} ?>
