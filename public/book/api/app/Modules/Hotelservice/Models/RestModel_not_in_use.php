...
class RestModel extends Model
{
    ...
    function super_admin_markup($web_partner_class_id, $region_type, $ApiSupplier)
    {
    ...
    function super_admin_discount($web_partner_class_id, $region_type, $ApiSupplier)
    {
    ...
    {
        $db = \Config\Database::connect('api');
        $builder = $db->table('tbo_hotel_log');
