            ...
            if ($multiresponse) {
                ...
                foreach ($multiresponse  as $supplierKey => $item) {
                    ...
                    if ($Return_Response) {
                        ...
                        $custom_indexData = $Return_Response['custom_index'];
                    }
                    $custom_index=array('RegionType'=>$region_type,'NoOfNights'=>$input['NoOfNights'],'NoOfRooms'=>$input['NoOfRooms'],'GuestNationality'=>$input['GuestNationality'],"CustomIndex"=>$custom_indexData);
