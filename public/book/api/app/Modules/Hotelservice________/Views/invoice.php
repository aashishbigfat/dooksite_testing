<div style="width: 100%; height: auto; background: #bbbdc0; margin: auto; padding-top: 50px; padding-bottom: 50px;">
    <center style="width: 850px;  height: auto; position: relative; background: #fff; margin: auto;   box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); font-family: 'Poppins', sans-serif; padding: 20px">
        ...
        <table style=" text-align: left; float: left;  width:50%; border-collapse: collapse; border: 1px solid #ddd;">
            <tr>
                <th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">City :</th>
                <td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px; "><?php echo $City; ?></td>
            </tr>
        ...
        <table style=" text-align: left; float: left;  width:50%; border-collapse: collapse; border: 1px solid #ddd;">
            <tr>
                <th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">Hotel Confirmation No :</th>
                <td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px; "><?php echo $ConfirmationNo; ?></td>
            </tr>

        </table>
        <table style=" text-align: left; float: left;  width:50%; border-collapse: collapse; border: 1px solid #ddd;">
            <tr>
                <th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">CheckIn :</th>
                <td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px; "><?php echo $CheckInDate; ?></td>
            </tr>

        </table>
        <table style=" text-align: left;   width:50%; border-collapse: collapse; border: 1px solid #ddd;">
            <tr>
                <th rowspan="0" style="padding: 5px 7px; text-align: left; font-weight: bold; font-size:13px;">CheckOut :</th>
                <td style=" padding: 5px 7px; text-align: right; font-weight: normal; font-size:13px;"><?php echo $CheckOutDate; ?></td>
            </tr>
