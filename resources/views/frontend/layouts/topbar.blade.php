<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
	<div class="container">
		...
		<div class="collapse navbar-collapse flex-column px-4" id="navbarSupportedContent">
			<div class="row navbar-nav w-100">
				<div class="col-md-8 px-0">
					<ul style="list-style: none" class="d-flex m-auto p-0">
						<li class="nav-item">
							<a class="nav-link an" aria-current="page" href="javascript:void(0)"><i
									class="fa fa-phone"></i> +911140001000</a>
						</li>
						<li class="nav-item">
							<a class="nav-link an" href="javascript:void(0)"><i class="fa fa-envelope"></i>
								sales@dooktravels.com</a>
						</li>
					</ul>
				</div>
			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link" href="javascript:void(0)" tabindex="-1"
						aria-disabled="true">Group Tours</a></li>
				<li class="nav-item dropdown">
				...
				<li class="mt-2" style="margin-left: 185px"><a class="agent_btn btn border-danger border-2 text-danger"
						href="javascript:void(0)" tabindex="-1" aria-disabled="true">Agent Connect</a></li>
				<li class="mt-2 mx-2"><a class="agent_btn btn btn-danger border-2 text-white" href="javascript:void(0)"
